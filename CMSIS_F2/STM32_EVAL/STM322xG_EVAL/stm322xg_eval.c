...
GPIO_TypeDef* BUTTON_PORT[BUTTONn] = {WAKEUP_BUTTON_GPIO_PORT, USER1_BUTTON_GPIO_PORT,
                                      USER2_BUTTON_GPIO_PORT}; 

const uint16_t BUTTON_PIN[BUTTONn] = {WAKEUP_BUTTON_PIN, USER1_BUTTON_PIN,
                                      USER2_BUTTON_PIN}; 

const uint32_t BUTTON_CLK[BUTTONn] = {WAKEUP_BUTTON_GPIO_CLK, USER1_BUTTON_GPIO_CLK,
                                      USER2_BUTTON_GPIO_CLK};
...
const uint8_t BUTTON_IRQn[BUTTONn] = {WAKEUP_BUTTON_EXTI_IRQn, USER1_BUTTON_EXTI_IRQn,
