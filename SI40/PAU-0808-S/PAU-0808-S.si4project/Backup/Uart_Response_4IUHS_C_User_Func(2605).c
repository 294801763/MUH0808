...
time:			24.11.5
****************************************************/
void mapp_SET_Input_Mute(u8 channel,u8 parameter1)
{
...
time:			24.11.5
****************************************************/
void mapp_SET_Input_Reverse_phase(u8 channel,u8 parameter1)
{
...
time:			24.11.5
****************************************************/
void mapp_SET_Input_Compressor_Ratio(u8 channel,u8 parameter1)
{
...
time:			24.11.5
****************************************************/
void mapp_SET_Input_EQ_Gain(u8 channel,u8 parameter1,u8 parameter2,u8 parameter3)
{
...
time:			24.11.5
****************************************************/
void mapp_SET_Input_HowlingSuppressor_Ctrl(u8 channel,u8 parameter1)
{
...
time:			24.11.5
****************************************************/
void mapp_SET_Input_NoiseSuppressor_Ctrl(u8 channel,u8 parameter2)
{
...
time:			24.11.5
****************************************************/
void mapp_SET_Input_EchoCanceller_Ctrl(u8 channel,u8 parameter1)
{
...
time:			24.11.5
****************************************************/
void mapp_SET_Input_Exciter_Ctrl(u8 channel,u8 parameter1)
{
...
time:			24.11.5
****************************************************/
void mapp_SET_Input_CallInput(u8 channel,u8 parameter1)
{
...
time:			24.11.5
****************************************************/
void mapp_SET_Input_BackgroundInput(u8 channel,u8 parameter1)
{
...
time:			24.11.5
****************************************************/
void mapp_SET_Input_Ducking_Ctrl(u8 parameter1,u8 parameter2)
{
...
static emCmdFuncStaType mapp_CmdfuncSetCardFunction(pstUartCom_t pCommVar,u8 cmdnum)
{
	...
	switch(l_u8CmdType)
	{
		...
		case 0x0b://输入压缩器阈值
			...
			break;
		case 0x0c://输入压缩器比率
			mapp_SET_Input_Compressor_Ratio(l_u8channel, parameter1);
			dbg_printf("l_u8CmdType:%d,l_u8channel:%d,parameter1:%d,parameter2:%d\r\n",l_u8CmdType,l_u8channel,parameter1,parameter2);
			break;
		case 0x0d://输入压缩器启动时间
		...
		case 0x20://噪声抑制释放时间
			...
			break;
		case 0x21://噪声抑制开关
			mapp_SET_Input_NoiseSuppressor_Ctrl(l_u8channel, parameter2);
			dbg_printf("l_u8CmdType:%d,l_u8channel:%d,parameter1:%d,parameter2:%d\r\n",l_u8CmdType,l_u8channel,parameter1,parameter2);
			break;
		case 0x22://回声消除等级
		...
		case 0x2e://闪避器释放时间
			...
			break;
		case 0x2f://闪避器开关
			mapp_SET_Input_Ducking_Ctrl(parameter1, parameter2);
			dbg_printf("l_u8CmdType:%d,l_u8channel:%d,parameter1:%d,parameter2:%d\r\n",l_u8CmdType,l_u8channel,parameter1,parameter2);
			break;
		case 0x30://矩阵切换
