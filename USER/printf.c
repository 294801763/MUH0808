...
int Uart_vsnprintf(char *str, size_t size, const char *fmt, va_list ap)
{
    ...
    reswitch:
        ...
        case 'u':
            ...
            break;
//		case 'f':
//			fDouble = va_arg(ap, double);
//			char float_buf[256];
//			snprintf(float_buf, sizeof(float_buf), "%.*f", prec, fDouble);
//			printf("%s", float_buf);
//			break;
...
int Uart2_printf(const char *fmt, ...)
{
    ...
    char                szPrint[PRINTF_CHAR_MAX];
    va_list             ap;
    pstUartDeclare_t    pstUart = (pstUartDeclare_t)&stProjectUartWorkTable[1];
...
int Uart3_printf(const char *fmt, ...)
{
    ...
    char                szPrint[PRINTF_CHAR_MAX];
    va_list             ap;
    pstUartDeclare_t    pstUart = (pstUartDeclare_t)&stProjectUartWorkTable[2];
