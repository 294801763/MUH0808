...
void GetResolutionText(char *ps8ResText,u8 u8ResID)
{
    switch(u8ResID)
    {
        ...
        case emRes_1920x1080_50:
            ...
            break;
        case emRes_1920x1080_30:
            memcpy(ps8ResText,"1920x1080@30Hz\0",strlen("1920x1080@30Hz\0"));
            break;
        case emRes_1920x1080_25:
            memcpy(ps8ResText,"1920x1080@25Hz\0",strlen("1920x1080@25Hz\0"));
            break;
...
bool app_SwitchResolution(u8 u8Tx,u8 u8ResID)
{
    ...
    switch(u8ResID)
    {
        ...
        case 16:    //1920x1080p30
            {
                l_bRetVal = TRUE;
                pstBasicVar->u8TxResolutionID[u8Tx-1] = emRes_1920x1080_30;
                app_MS1826TxResolutionChange(0,(l_u8RealPort-1)%4,emRes_1920x1080_30);
            }
            break;
        ...
        case 18:    //1920x1080p25
            {
                l_bRetVal = TRUE;
                pstBasicVar->u8TxResolutionID[u8Tx-1] = emRes_1920x1080_25;
                app_MS1826TxResolutionChange(0,(l_u8RealPort-1)%4,emRes_1920x1080_25);
            }
            break;
