...
//    pstSpecVar->stBasSpecVar.bIsDebugEn = FALSE;
    ...
    for(i=0;i<Def_outport_num;i++)
    {
        ...
        pstSpecVar->stBasSpecVar.u8Hue[i]            = 0;
...
//        app_MS1826TxHdcpEnable(0,i,pstBasicVar->u8TxHdcpMode[i]);       //no hdcp key
        ...
        app_LMX_4OUHS_CPictureAdjust(i,pstBasicVar->u8Saturation[i],MS1826_ADJUST_SATURATION);
...
{
	if(u8Mode == MS1826_ADJUST_HUE)
		app_MS1826PictureAdjust(0,u8Tx,u8Value,u8Mode);
	else
