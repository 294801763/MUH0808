...
const stGpioConfig_t stProjectGpioTable[eGpioName_Max]=
{
    ...
    //48V_CTR
    //eGpioName_48V_CTR1,
    {PORT_GPIOB,        GPIO_Pin_1, GPIO_Mode_Out_PP,       ePinLevel_Low},
    //eGpioName_48V_CTR2,
    {PORT_GPIOB,        GPIO_Pin_0, GPIO_Mode_Out_PP,       ePinLevel_Low},
    //eGpioName_48V_CTR3,
    {PORT_GPIOC,        GPIO_Pin_5, GPIO_Mode_Out_PP,       ePinLevel_Low},
    //eGpioName_48V_CTR4,
    {PORT_GPIOC,        GPIO_Pin_4, GPIO_Mode_Out_PP,       ePinLevel_Low},
	//eGpioName_48V_CTR5,
	{PORT_GPIOA,		GPIO_Pin_1, GPIO_Mode_Out_PP,		ePinLevel_Low},
	//eGpioName_48V_CTR6,
	{PORT_GPIOA,		GPIO_Pin_0, GPIO_Mode_Out_PP,		ePinLevel_Low},
	//eGpioName_48V_CTR7,
	{PORT_GPIOC,		GPIO_Pin_3, GPIO_Mode_Out_PP,		ePinLevel_Low},
	//eGpioName_48V_CTR8,
	{PORT_GPIOC,		GPIO_Pin_2, GPIO_Mode_Out_PP,		ePinLevel_Low},
