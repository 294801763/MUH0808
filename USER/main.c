...
QueueHandle_t xQueue_GUIEProcess = NULL;
...
int main(void)
{
    ...
    RS232_printf("111111111111111111111111111111111111111111111111111\r\n");
...
static void AppQueueCreate(void)
{
    ...
    xQueue_GUIEProcess = xQueueCreate(1, sizeof(pststMachVal_t));
    if(xQueue_GUIEProcess == 0)
    {
        Msg_SemC(("xQueue_EProcess create failed\r\n"));
    }
				...
				#if 0
				//GUI - 分块写入
    xQueue_EGUIProcess = xQueueCreate(10, sizeof(stMachVal_t));
    if(xQueue_EProcess == 0)
    {
        Msg_SemC(("xQueue_EProcess create failed\r\n"));
    }
