...
extern IT6635_DEVICE_DATA gdev[IT6635_I2C_DEV_NUM];

extern const u8 RS_Value[];
extern _CODE IT6635_RX_OPTIONS s_RxOpts;
extern _CODE IT6635_TX_OPTIONS s_TxOpts;
extern _CODE IT6635_DEV_OPTION s_DevOpts;
extern _CODE u8 s_default_edid_port0[];
...
#define _rx_edid_ram_enable(port) { if ( g_pstDev->opts.rx_opt[port]->EnRxDDCBypass == 0 ) { h2swset(0x55 + port, 0x01, 0x00); } }
