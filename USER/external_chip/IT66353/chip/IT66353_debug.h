...
#define PR_INFO(x)      {pr_info("IT66353[%d]",g_u8ITEDevice);pr_info x;}
#define PR_INFO2(x)     {pr_info2("IT66353[%d]",g_u8ITEDevice);pr_info2 x;}
#define PR_ERR(x)       {pr_err("IT66353[%d]",g_u8ITEDevice);pr_err x;}
#define PR_AEQ(x)       {pr_info("IT66353[%d]",g_u8ITEDevice);{pr_info x ;};}
#define PR_DATA(x)      {pr_info x ;}
