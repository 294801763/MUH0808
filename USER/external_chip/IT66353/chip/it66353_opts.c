...
static IT6635_RX_OPTIONS st_RxOptsNum[IT6635_I2C_DEV_NUM];
static IT6635_TX_OPTIONS st_TxOptsNum[IT6635_I2C_DEV_NUM];
static IT6635_DEV_OPTION st_DevOptsNum[IT6635_I2C_DEV_NUM];
...
void it6635_options_init(void)
{
    ...
    g_pstDev->opts.rx_opt[0] = (IT6635_RX_OPTIONS*)&st_RxOptsNum[g_u8ITEDevice];
    g_pstDev->opts.rx_opt[1] = (IT6635_RX_OPTIONS*)&st_RxOptsNum[g_u8ITEDevice];
    g_pstDev->opts.rx_opt[2] = (IT6635_RX_OPTIONS*)&st_RxOptsNum[g_u8ITEDevice];
    g_pstDev->opts.rx_opt[3] = (IT6635_RX_OPTIONS*)&st_RxOptsNum[g_u8ITEDevice];
    g_pstDev->opts.active_rx_opt = g_pstDev->opts.rx_opt[DEFAULT_PORT];
    g_pstDev->opts.tx_opt = (IT6635_TX_OPTIONS*)&st_TxOptsNum[g_u8ITEDevice];
    g_pstDev->opts.dev_opt = (IT6635_DEV_OPTION*)&st_DevOptsNum[g_u8ITEDevice];
