...
static VOID _splicer_vipss_rx_mux_cfg(UINT8 u8Dev,UINT8 u8_vipss_sel, SPLICER_APP_T *pst_app_splicer_dev)
{
	...
	if(g_st_hdmi_rx[u8Dev][pst_app_splicer_dev->u8_src_sel].u8_color_space == HDMI_COLORSPACE_YCBCR420)
	{
		...
		g_stVideo_HDMIRx_Timing[u8Dev][pst_app_splicer_dev->u8_src_sel].u16_vactive = g_st_hdmi_rx[u8Dev][pst_app_splicer_dev->u8_src_sel].st_rx_video_timing.u16_vactive / 2;
	}
	else
	{
		//vipss rx csc config
		...
		if(g_st_hdmi_rx[u8Dev][pst_app_splicer_dev->u8_src_sel].st_rx_video_timing.u8_polarity % 2 == 0)
		{
			switch(g_st_hdmi_rx[u8Dev][pst_app_splicer_dev->u8_src_sel].st_rx_video_timing.u16_vactive)
			{
				case 1080:
					...
					g_stVideo_HDMIRx_Timing[u8Dev][pst_app_splicer_dev->u8_src_sel].u16_vactive = 1080;
					break;
				case 480:
					//vipss mux config
					api_misc_vipss_mux_cfg(u8_vipss_sel, MISC_VIPSS_MUXTYPE_8);       //< CSC ->DEINT-> SDN -> VWDMA1
					...
					api_deint_init(&g_st_deint_dev[u8Dev]);
					api_deint_config(&g_st_deint_dev[u8Dev]);
					g_stVideo_HDMIRx_Timing[u8Dev][pst_app_splicer_dev->u8_src_sel].u16_hactive = g_st_hdmi_rx[u8Dev][pst_app_splicer_dev->u8_src_sel].st_rx_video_timing.u16_hactive / 2;
					g_stVideo_HDMIRx_Timing[u8Dev][pst_app_splicer_dev->u8_src_sel].u16_vactive = 480;
					break;
				case 576:
					//vipss mux config
					api_misc_vipss_mux_cfg(u8_vipss_sel, MISC_VIPSS_MUXTYPE_8);       //< CSC ->DEINT-> SDN -> VWDMA1
					...
					api_deint_config(&g_st_deint_dev[u8Dev]);
					g_stVideo_HDMIRx_Timing[u8Dev][pst_app_splicer_dev->u8_src_sel].u16_hactive = g_st_hdmi_rx[u8Dev][pst_app_splicer_dev->u8_src_sel].st_rx_video_timing.u16_hactive / 2;
					g_stVideo_HDMIRx_Timing[u8Dev][pst_app_splicer_dev->u8_src_sel].u16_vactive = 576;
					break;
				default:
		...
		else
		{
			if(g_st_hdmi_rx[u8Dev][pst_app_splicer_dev->u8_src_sel].st_rx_video_timing.u8_polarity % 2 == 0)
			{
				g_st_deint_dev[u8Dev].b_deint_en = MS_FALSE;
				api_deint_config(&g_st_deint_dev[u8Dev]);
				g_stVideo_HDMIRx_Timing[u8Dev][pst_app_splicer_dev->u8_src_sel].u16_hactive = g_st_hdmi_rx[u8Dev][pst_app_splicer_dev->u8_src_sel].st_rx_video_timing.u16_hactive;
				g_stVideo_HDMIRx_Timing[u8Dev][pst_app_splicer_dev->u8_src_sel].u16_vactive = g_st_hdmi_rx[u8Dev][pst_app_splicer_dev->u8_src_sel].st_rx_video_timing.u16_vactive / 2;
			}
			//vipss mux config
			api_misc_vipss_mux_cfg(u8_vipss_sel, MISC_VIPSS_MUXTYPE_4);       //< CSC -> SDN -> VWDMA1
...
VOID _splicer_video_freeze(UINT8 u8Dev,UINT8 u8_vipss_sel)
{
	...
	u8_rdma_buf_id[u8Dev] = gst_splicer_vipss_dev[u8Dev][u8_vipss_sel].st_splicer_com_wdma_dev.st_dma_status.u8_rdma_buf_id;
	u8_wdma_buf_id[u8Dev] = (u8_rdma_buf_id[u8Dev] + 1) % 3;

	gst_splicer_vipss_dev[u8Dev][u8_vipss_sel].st_splicer_com_wdma_dev.st_frc_cfg.u8_src_buf_id_sel = u8_wdma_buf_id[u8Dev];
	gst_splicer_vipss_dev[u8Dev][u8_vipss_sel].st_splicer_com_wdma_dev.st_frc_cfg.u8_dst_buf_id_sel = u8_rdma_buf_id[u8Dev];
...
static VOID _splicer_mode_frc_cfg(UINT8 u8Dev)
{
	...
	gst_splicer_vopss_dev[u8Dev][VOPSS1].st_splicer_com_rdma_dev.st_frc_cfg.b_frc_ctl_ext = MS_FALSE;
...
VOID app_splicer_rx_smeless_switch(UINT8 u8Dev,SPLICER_APP_T *pst_app_splicer_dev)
{
	...
	pst_app_splicer_dev->tSdn_InSize.u16_h = g_stVideo_HDMIRx_Timing[u8Dev][pst_app_splicer_dev->u8_src_sel].u16_hactive > 0 ? g_stVideo_HDMIRx_Timing[u8Dev][pst_app_splicer_dev->u8_src_sel].u16_hactive : 1920;
	pst_app_splicer_dev->tSdn_InSize.u16_v = g_stVideo_HDMIRx_Timing[u8Dev][pst_app_splicer_dev->u8_src_sel].u16_vactive > 0 ? g_stVideo_HDMIRx_Timing[u8Dev][pst_app_splicer_dev->u8_src_sel].u16_vactive : 1080;
...
VOID app_splicer_mode_config(UINT8 u8Dev,SPLICER_APP_T *pst_app_splicer_dev)
{
	...
	if(pst_app_splicer_dev->b_splicer_sw != MS_TRUE)
	{
		...
		gst_splicer_vipss_dev[u8Dev][0].st_splicer_vwdma_dev.b_enable = MS_FALSE;
		...
		gst_splicer_vipss_dev[u8Dev][1].st_splicer_vwdma_dev.b_enable = MS_FALSE;
		...
		gst_splicer_vipss_dev[u8Dev][2].st_splicer_vwdma_dev.b_enable = MS_FALSE;
		...
		gst_splicer_vipss_dev[u8Dev][3].st_splicer_vwdma_dev.b_enable = MS_FALSE;
    ...
    Vipss_Mapping_Rx[u8Dev][g_u8_splicer_vipss_sel[u8Dev]] = g_u8_HDMI_RX_PROT[pst_app_splicer_dev->u8_src_sel];
...
VOID app_splicer_osd_config(UINT8 u8Dev)
{
	...
	for(u8_idx = 0; u8_idx < 4; u8_idx ++)
	{
		api_osd_window_position_set(&g_st_osd_dev[u8Dev][u8_idx], &st_osd_win_size[u8Dev]);
		st_font[u8Dev].u8_y = 0;
		st_font[u8Dev].pu16_idx = (UINT16 *)str_osd_input_channel[gst_splicer_app_dev[u8Dev].u8_src_sel];
		st_font[u8Dev].u16_length = 5;
		api_osd_show_index(&g_st_osd_dev[u8Dev][u8_idx], &st_font[u8Dev]);

		st_font[u8Dev].u8_y = 1;
		st_font[u8Dev].pu16_idx = (UINT16 *)str_osd_output_channel[u8_idx];
		st_font[u8Dev].u16_length = 5;
		api_osd_show_index(&g_st_osd_dev[u8Dev][u8_idx], &st_font[u8Dev]);
		...
		api_osd_show_length_string(&g_st_osd_dev[u8Dev][u8_idx], &st_str[u8Dev]);
	}
