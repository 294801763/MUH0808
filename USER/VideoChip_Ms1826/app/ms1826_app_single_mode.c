...
extern void app_single_user_splitter_process(UINT8 u8Dev,UINT8 u8_rx_idx);
...
VOID _single_vipss_cfg(UINT8 u8Dev,BOOL b_is_dsc,UINT8 u8_vipss_sel)
{
    UINT16 u16_in_size_h[4], u16_in_size_v[4];
#if (MS1826_VIPSS1_DEINT==0)
    u16_in_size_h[u8_vipss_sel] = g_stVideo_HDMIRx_Timing[u8Dev][Vipss_Mapping_Rx[u8Dev][u8_vipss_sel]].u16_hactive;
    u16_in_size_v[u8_vipss_sel] = g_stVideo_HDMIRx_Timing[u8Dev][Vipss_Mapping_Rx[u8Dev][u8_vipss_sel]].u16_vactive;
#endif
    //vipss rx sel
    gst_single_vipss_dev[u8Dev][u8_vipss_sel].st_vipss_mux_dev.u8_src_module = g_u8_misc_module_rx[g_u8_HDMI_RX_PROT[Vipss_Mapping_Rx[u8Dev][u8_vipss_sel]]];
    ...
    if(g_st_hdmi_rx[u8Dev][Vipss_Mapping_Rx[u8Dev][u8_vipss_sel]].u8_color_space == HDMI_COLORSPACE_YCBCR420)
    {
    ...
    else
    {
        ...
        #endif
            g_st_vipss_csc[u8Dev][u8_vipss_sel].st_csc_config_param.csc_in_colorspace = g_st_hdmi_rx[u8Dev][Vipss_Mapping_Rx[u8Dev][u8_vipss_sel]].u8_color_space;
        g_st_vipss_csc[u8Dev][u8_vipss_sel].st_csc_config_param.csc_out_colorspace = CHIP_INTERNAL_PROCESS_COLORSPACE;
        g_st_vipss_csc[u8Dev][u8_vipss_sel].st_csc_config_param.csc_out_color_range = CHIP_INTERNAL_PROCESS_COLORRANGE;
        g_st_vipss_csc[u8Dev][u8_vipss_sel].st_csc_config_param.u8_pixel_repeat  = HDMI_PIXEL_REPEAT_X1;
    }
    if(g_st_hdmi_rx[u8Dev][Vipss_Mapping_Rx[u8Dev][u8_vipss_sel]].b_is_hdmi == MS_FALSE)
		g_st_vipss_csc[u8Dev][u8_vipss_sel].st_csc_config_param.csc_in_colorspace = HDMI_COLORSPACE_RGB;
    ...
    if(b_is_dsc)
    {
        ...
        if(g_st_hdmi_rx[u8Dev][Vipss_Mapping_Rx[u8Dev][u8_vipss_sel]].u8_color_space == HDMI_COLORSPACE_YCBCR420)
        {
            ...
            u16_in_size_v[u8_vipss_sel] = g_stVideo_HDMIRx_Timing[u8Dev][Vipss_Mapping_Rx[u8Dev][u8_vipss_sel]].u16_vactive / 2;
        }
        else
        {
		...
		if(g_bSplitterEnable[u8Dev][u8_vipss_sel])
        {
			...
			gst_single_vipss_dev[u8Dev][u8_vipss_sel].st_single_vwdma_dev.u16_request_len                           = 254;
        ...
        else
        {
            ...
            // I2P
        #if (MS1826_VIPSS1_DEINT==0)
            if(g_st_hdmi_rx[u8Dev][Vipss_Mapping_Rx[u8Dev][u8_vipss_sel]].st_rx_video_timing.u8_polarity % 2 == 0)
            {
                gst_single_vipss_dev[u8Dev][u8_vipss_sel].st_single_sdn_dev.st_video_size.st_InRect.u16_h = u16_in_size_h[u8_vipss_sel] ? u16_in_size_h[u8_vipss_sel] : 1920;
    ...
    else
    {
		...
		if(g_st_hdmi_rx[u8Dev][Vipss_Mapping_Rx[u8Dev][u8_vipss_sel]].st_rx_video_timing.u8_polarity % 2 == 0 && u8_vipss_sel == VIPSS1)
		{
			LOG("1111111111111 Input is interlace 1111111111111\r\n");
			switch(g_st_hdmi_rx[u8Dev][Vipss_Mapping_Rx[u8Dev][u8_vipss_sel]].st_rx_video_timing.u16_vactive*2)
			{
				case 1080:
					//vipss mux config
					...
					g_stVideo_HDMIRx_Timing[u8Dev][Vipss_Mapping_Rx[u8Dev][u8_vipss_sel]].u16_vactive = 1080;
                    LOG("1080i\r\n");
					break;
				case 480:
					//vipss mux config
					...
					g_st_deint_dev[u8Dev].b_hd_full_mode = MS_FALSE;
					g_st_deint_dev[u8Dev].u32_buff0_start_addr = 0;
					g_st_deint_dev[u8Dev].u32_buff1_start_addr = 4000000;
					api_deint_init(&g_st_deint_dev[u8Dev]);
					api_deint_config(&g_st_deint_dev[u8Dev]);
					g_stVideo_HDMIRx_Timing[u8Dev][Vipss_Mapping_Rx[u8Dev][u8_vipss_sel]].u16_hactive = g_st_hdmi_rx[u8Dev][Vipss_Mapping_Rx[u8Dev][u8_vipss_sel]].st_rx_video_timing.u16_hactive/2;
					g_stVideo_HDMIRx_Timing[u8Dev][Vipss_Mapping_Rx[u8Dev][u8_vipss_sel]].u16_vactive = 480;
                    LOG("480i\r\n");
					break;
				case 576:
					//vipss mux config
					...
					api_deint_config(&g_st_deint_dev[u8Dev]);
					g_stVideo_HDMIRx_Timing[u8Dev][Vipss_Mapping_Rx[u8Dev][u8_vipss_sel]].u16_hactive = g_st_hdmi_rx[u8Dev][Vipss_Mapping_Rx[u8Dev][u8_vipss_sel]].st_rx_video_timing.u16_hactive/2;
					g_stVideo_HDMIRx_Timing[u8Dev][Vipss_Mapping_Rx[u8Dev][u8_vipss_sel]].u16_vactive = 576;
                    LOG("576i\r\n");
					break;
				default:
					g_st_deint_dev[u8Dev].b_deint_en = MS_FALSE;
					api_deint_config(&g_st_deint_dev[u8Dev]);
					//vipss mux config
					api_misc_vipss_mux_cfg(u8_vipss_sel, MISC_VIPSS_MUXTYPE_4);       //< CSC -> SDN -> VWDMA1
					break;
		...
		else
		{
			if(g_st_hdmi_rx[u8Dev][Vipss_Mapping_Rx[u8Dev][u8_vipss_sel]].st_rx_video_timing.u8_polarity % 2 == 0)
			{
				g_st_deint_dev[u8Dev].b_deint_en = MS_FALSE;
				api_deint_config(&g_st_deint_dev[u8Dev]);
				g_stVideo_HDMIRx_Timing[u8Dev][Vipss_Mapping_Rx[u8Dev][u8_vipss_sel]].u16_hactive = g_st_hdmi_rx[u8Dev][Vipss_Mapping_Rx[u8Dev][u8_vipss_sel]].st_rx_video_timing.u16_hactive;
				g_stVideo_HDMIRx_Timing[u8Dev][Vipss_Mapping_Rx[u8Dev][u8_vipss_sel]].u16_vactive = g_st_hdmi_rx[u8Dev][Vipss_Mapping_Rx[u8Dev][u8_vipss_sel]].st_rx_video_timing.u16_vactive / 2;
        ...
        if(g_bSplitterEnable[u8Dev][u8_vipss_sel])
        {
            ...
            gst_single_vipss_dev[u8Dev][u8_vipss_sel].st_single_vwdma_dev.b_enable = MS_FALSE;
            api_vwdma_enable_set(&gst_single_vipss_dev[u8Dev][u8_vipss_sel].st_single_vwdma_dev);
            gst_single_vipss_dev[u8Dev][u8_vipss_sel].st_single_vwdma_dev.u16_request_len = 254;
            api_vwdma_request_len_cfg(&gst_single_vipss_dev[u8Dev][u8_vipss_sel].st_single_vwdma_dev);
...
VOID _single_vopss_cfg(UINT8 u8Dev,BOOL b_is_dsc,UINT8 u8_vopss_sel)
{
    ...
    if(!b_is_dsc)
    {
        if(g_bSplitterEnable[u8Dev][u8_vopss_sel])
        {
            ...
            gst_single_vopss_dev[u8Dev][u8_vopss_sel].st_single_vrdma_dev.b_enable = MS_FALSE;
        ...
        gst_single_vopss_dev[u8Dev][u8_vopss_sel].st_single_vrdma_dev.u16_request_len = 254;
...
VOID _single_mode_frc_cfg(UINT8 u8Dev)
{
    ...
    gst_single_vopss_dev[u8Dev][VOPSS1].st_single_com_rdma_dev.st_frc_cfg.b_frc_ctl_ext       = MS_FALSE;
    ...
    gst_single_vopss_dev[u8Dev][VOPSS2].st_single_com_rdma_dev.st_frc_cfg.b_frc_ctl_ext = MS_FALSE;
#if ENABLE_MS1826_FRC_MODE_SWITCH
    //add by wf8421 20230726
    if(g_u8_display_mode[u8Dev] == MS1826_SEAMLESS_MATRIX_SWITCHER_OUT /*&& !g_bSplicerEnable[u8Dev][VOPSS2]*/)
    {
    ...
    gst_single_vopss_dev[u8Dev][VOPSS3].st_single_com_rdma_dev.st_frc_cfg.b_frc_ctl_ext = MS_FALSE;
#if ENABLE_MS1826_FRC_MODE_SWITCH
    //add by wf8421 20230726
    if(g_u8_display_mode[u8Dev] == MS1826_SEAMLESS_MATRIX_SWITCHER_OUT /*&& !g_bSplicerEnable[u8Dev][VOPSS3]*/)
    {
    ...
    gst_single_vopss_dev[u8Dev][VOPSS4].st_single_com_rdma_dev.st_frc_cfg.b_frc_ctl_ext = MS_FALSE;
#if ENABLE_MS1826_FRC_MODE_SWITCH
    //add by wf8421 20230726
    if(g_u8_display_mode[u8Dev] == MS1826_SEAMLESS_MATRIX_SWITCHER_OUT)
    {
...
//    LOG("single_video_mute TX%d mute sta:%s\r\n",u8_path,b_mute?"TRUE":"FALSE");
	...
	#if (_PROJECT_CURRENT_SELECT == _PROJECT_LMX_4OUHS_C)   //不然会导致上电绿屏一直覆盖正常画面
	
	#elif (_PROJECT_CURRENT_SELECT == _PROJECT_LMX_4IUHS_C)
    if(b_mute)
	{
		gst_pattern.b_enable = MS_TRUE;
		gst_pattern.u8_pattern = MISC_RXPATTERN_MODE_PURE_BLACK;
		gst_pattern.u8_pattern_idx = MISC_RXPATTERN_1 + u8_path;
		gst_pattern.u8_timing = MISC_RXPATTERN_1080P;
		api_misc_rxpattern_cfg(&gst_pattern);
		gst_single_vipss_dev[u8Dev][u8_path].st_vipss_mux_dev.u8_src_module = MISC_VIDEO_MODULE_RXPATTERN;   
		gst_single_vipss_dev[u8Dev][u8_path].st_vipss_mux_dev.u8_dst_module = g_u8_misc_module_vipss[u8_path];
		api_misc_rx_mux_cfg(&gst_single_vipss_dev[u8Dev][u8_path].st_vipss_mux_dev);  
	}
	#endif
}
...
VOID _single_video_freeze(UINT8 u8Dev,UINT8 u8_path_sel)
{
    ...
    u8_wdma_buf_id[u8Dev] = st_dma_dev.st_dma_status.u8_wdma_buf_id;
    u8_rdma_buf_id[u8Dev] = st_dma_dev.st_dma_status.u8_rdma_buf_id;
    u8_wdma_buf_id[u8Dev] = (u8_rdma_buf_id[u8Dev] + 1) % 3;
    st_dma_dev.st_frc_cfg.u8_src_buf_id_sel = u8_wdma_buf_id[u8Dev];
    st_dma_dev.st_frc_cfg.u8_dst_buf_id_sel = u8_rdma_buf_id[u8Dev];
...
VOID _single_video_unfreeze(UINT8 u8Dev,UINT8 u8_path_sel)
{
    ...
    st_dma_dev.st_frc_cfg.u8_src_buf_id_sel = (u8_wdma_buf_id[u8Dev] + 0) % 3;
    st_dma_dev.st_frc_cfg.u8_dst_buf_id_sel = (u8_wdma_buf_id[u8Dev] + 2) % 3;
    api_dma_comom_buf_id_set(&st_dma_dev);
...
VOID app_single_mode_config(UINT8 u8Dev)
{
    ...
    _single_vipss_cfg(u8Dev,g_dsc_enable[u8Dev],VIPSS1);
    _single_vipss_cfg(u8Dev,g_dsc_enable[u8Dev],VIPSS2);
    _single_vipss_cfg(u8Dev,g_dsc_enable[u8Dev],VIPSS3);
    _single_vipss_cfg(u8Dev,g_dsc_enable[u8Dev],VIPSS4);
    ...
    for(u8_i = 0; u8_i < 4; u8_i ++)
    {
        ...
        api_hdmi_tx_output_en(&g_st_hdmi_tx[u8Dev][u8_i],MS_FALSE);
...
VOID app_single_mode_rx_switch(UINT8 u8Dev,UINT8 u8_rx, UINT8 u8_tx)
{
    ...
    Vipss_Mapping_Rx[u8Dev][u8_tx] = u8_rx;
    _single_vipss_cfg(u8Dev,g_dsc_enable[u8Dev],u8_tx);
...
//        _video_mute(u8Dev,u8_rx, TRUE);
//    else
//        _video_mute(u8Dev,u8_rx, FALSE);

    //tx audio config
    app_tx_audio_cfg(u8Dev, u8_rx, u8_tx);
    g_bOSDShown[u8Dev] = MS_TRUE;
    sys_show_osd(u8Dev,g_bOSDShown[u8Dev], 0x0F & 1<<u8_tx);
}
...
VOID app_single_output_resolution(UINT8 u8Dev)
{
    ...
    for(i = 0 ; i < 4 ; i ++)
    {
        ...
        api_hdmi_tx_output_en(&g_st_hdmi_tx[u8Dev][i], MS_FALSE);
...
VOID app_single_process(UINT8 u8Dev,UINT8 u8_rx_idx)
{
    if(g_bSplitterEnable[u8Dev][u8_rx_idx])
    {
        app_single_user_splitter_process(u8Dev,u8_rx_idx);
    }
    else
    {
        UINT8 b_int = 0;
        SS_DEV_T st_split_vopss_ss_dev;
        st_split_vopss_ss_dev.u8_sel = g_dsc_enable[u8Dev] ? g_u8_ss_ch_dsc_idx[u8_rx_idx]:g_u8_ss_ch_idx[u8_rx_idx];
        ...
        LOG("app_single_process [%d]\r\n",u8_rx_idx);
        _single_vipss_cfg(u8Dev,g_dsc_enable[u8Dev],u8_rx_idx);
        app_video_vipss_trig(u8Dev,g_dsc_enable[u8Dev] ? g_u8_ss_ch_dsc_idx[u8_rx_idx]:g_u8_ss_ch_idx[u8_rx_idx]);
        _single_vopss_cfg(u8Dev,g_dsc_enable[u8Dev],u8_rx_idx);
        g_u16_timer_out = 0;
        api_misc_int_status_clr(g_u8_vb_vdstmg[u8_rx_idx]);
        do
        {
            g_u16_timer_out ++;
            b_int = api_misc_int_status_get(g_u8_vb_vdstmg[u8_rx_idx]);
        }
        while((b_int != MS_TRUE) && (g_u16_timer_out < 500));

        if(g_dsc_enable[u8Dev])
        {
            api_dsc_decoder_pps_seamless_set(&gst_single_vopss_dev[u8Dev][u8_rx_idx].st_decoder_dev);
        }
...
VOID app_single_osd_config(UINT8 u8Dev,UINT8 u8_index)
{
    ...
    {
        //if(u8_index & 0x01)
        if((u8_index>>Vipss_Mapping_Rx[u8Dev][u8_i])&0x01)
        {
            api_osd_window_position_set(&g_st_osd_dev[u8Dev][u8_i], &st_osd_win_size[u8Dev]);
            st_font[u8Dev].u8_y = 0;
            st_font[u8Dev].pu16_idx = (UINT16 *)str_osd_input_channel[Vipss_Mapping_Rx[u8Dev][u8_i]];
            ...
            st_str[u8Dev].u8_y = 2;
            set_osd_res(u8Dev,Vipss_Mapping_Rx[u8Dev][u8_i]);
...
//    st_osd_win_size[u8Dev].u16_y = 100;
    ...
    for(u8_i = 0; u8_i < 4; u8_i ++)
    {
        ...
        if((u8_index>>Vipss_Mapping_Rx[u8Dev][u8_i])&0x01)
        {
            if(g_user_osd_str_enable[u8Dev][Vipss_Mapping_Rx[u8Dev][u8_i]])
            {
                ...
                st_user_osd_win_size[u8Dev][u8_i].u16_x = g_u16UserStrDispPos[u8Dev][Vipss_Mapping_Rx[u8Dev][u8_i]][0];
                st_user_osd_win_size[u8Dev][u8_i].u16_y = g_u16UserStrDispPos[u8Dev][Vipss_Mapping_Rx[u8Dev][u8_i]][1];
                api_osd_window_position_set(&g_st_osd_dev[u8Dev][u8_i], &st_user_osd_win_size[u8Dev][u8_i]);
                st_str[u8Dev].u8_y = 0;
                app_ms1826_get_osd_string(u8Dev,Vipss_Mapping_Rx[u8Dev][u8_i]);
                st_str[u8Dev].pstr = p_str;
                st_str[u8Dev].u16_len = MS1826_OSD_MAX_LEN;
                api_osd_show_length_string(&g_st_osd_dev[u8Dev][u8_i], &st_str[u8Dev]);
                app_osd_trigger(u8Dev,u8_i);
            }
            OSD_COLOR_TABLE[u8_i*16*3+3] = g_user_osd_string_color[u8Dev][Vipss_Mapping_Rx[u8Dev][u8_i]][0];
            OSD_COLOR_TABLE[u8_i*16*3+4] = g_user_osd_string_color[u8Dev][Vipss_Mapping_Rx[u8Dev][u8_i]][1];
            OSD_COLOR_TABLE[u8_i*16*3+5] = g_user_osd_string_color[u8Dev][Vipss_Mapping_Rx[u8Dev][u8_i]][2];
...
VOID _video_freeze(UINT8 u8Dev,UINT8 u8_path)
{
    ...
    for(i=0;i<4;i++)
    {
        if(u8_path&(1<<i))
        {
            ...
            u8_wdma_buf_id[u8Dev] = st_dma_dev[i].st_dma_status.u8_wdma_buf_id;
            u8_rdma_buf_id[u8Dev] = st_dma_dev[i].st_dma_status.u8_rdma_buf_id;
            u8_wdma_buf_id[u8Dev] = (u8_rdma_buf_id[u8Dev] + 1) % 3;
            st_dma_dev[i].st_frc_cfg.u8_src_buf_id_sel = u8_wdma_buf_id[u8Dev];
            st_dma_dev[i].st_frc_cfg.u8_dst_buf_id_sel = u8_rdma_buf_id[u8Dev];
    ...
    for(j=0;j<u8_num;j++)
    {
        ...
        for(i=0;i<4;i++)
        {
            if(pu8_path[j]&(1<<i))
            {
                ...
                api_dma_common_buf_id_get(&st_dma_dev[i]);
                u8_wdma_buf_id[u8StartDev+j] = st_dma_dev[i].st_dma_status.u8_wdma_buf_id;
                u8_rdma_buf_id[u8StartDev+j] = st_dma_dev[i].st_dma_status.u8_rdma_buf_id;
                u8_wdma_buf_id[u8StartDev+j] = (u8_rdma_buf_id[u8StartDev+j] + 1) % 3;
                st_dma_dev[i].st_frc_cfg.u8_src_buf_id_sel = u8_wdma_buf_id[u8StartDev+j];
                st_dma_dev[i].st_frc_cfg.u8_dst_buf_id_sel = u8_rdma_buf_id[u8StartDev+j];
                api_dma_comom_buf_id_set(&st_dma_dev[i]);
                api_dma_common_trigger(&st_dma_dev[i]);
            }
        }
...
VOID _video_unfreeze(UINT8 u8Dev,UINT8 u8_path)
{
    ...
    for(i=0;i<4;i++)
    {
        if(u8_path&(1<<i))
        {
            ...
            st_dma_dev[i].st_frc_cfg.u8_src_buf_id_sel = (u8_wdma_buf_id[u8Dev] + 0) % 3;
            st_dma_dev[i].st_frc_cfg.u8_dst_buf_id_sel = (u8_wdma_buf_id[u8Dev] + 2) % 3;
...
//        if(u8_path&(1<<i))
//        {
//			u8_rx_clock = ms1826_hal_hdmi_rx_get_tmds_clk(Vipss_Mapping_Rx[u8Dev][i]);
//			if(u8_rx_clock == 0)
//			{
//                b_freeze_status[u8Dev][i] = FALSE;
//				_video_mute(u8Dev,i, MS_TRUE);
//			}

//            u32_rx_mdt_ints = ms1826_hal_hdmi_rx_get_mdt_ints_ext(Vipss_Mapping_Rx[u8Dev][i]);
//			api_hdmi_rx_update_state(&g_st_hdmi_rx[u8Dev][Vipss_Mapping_Rx[u8Dev][i]]);
//            if(u32_rx_mdt_ints & 0x3045)
//                ms1826_hal_hdmi_rx_phy_process(Vipss_Mapping_Rx[u8Dev][i], g_st_hdmi_rx[u8Dev][Vipss_Mapping_Rx[u8Dev][i]].st_rx_ints.b_clk_change, u8_rx_clock);
//			ms1826_hal_hdmi_rx_phy_process(Vipss_Mapping_Rx[u8Dev][i], g_st_hdmi_rx[u8Dev][Vipss_Mapping_Rx[u8Dev][i]].st_rx_ints.b_clk_change, u8_rx_clock);
//		}
//    }
//	__disable_irq();
...
//        	st_dma_dev[i].st_frc_cfg.u8_src_buf_id_sel = (u8_wdma_buf_id[u8Dev] + 1) % 3;
//        	st_dma_dev[i].st_frc_cfg.u8_dst_buf_id_sel = (u8_wdma_buf_id[u8Dev] + 0) % 3;
//        	api_dma_comom_buf_id_set(&st_dma_dev[i]);
...
//			if(u8_rx_clock != 0)
//			{
//                LOG(" unfreeze have signal to unmute video RX%d\r\n",Vipss_Mapping_Rx[u8Dev][i]);
//                b_freeze_status[u8Dev][i] = FALSE;
//				_video_mute(u8Dev,Vipss_Mapping_Rx[u8Dev][i], MS_FALSE);//wu    不屏蔽是为解决切所有的时候会不出图

////                api_hdmi_tx_audio_mute(&g_st_hdmi_tx[u8Dev][i],MS_FALSE);
//			}
//		}
//    }
//}
VOID _video_unfreeze_out(UINT8 u8Dev,UINT8 u8_path)
{
    ...
    for(u8_i = 0; u8_i < 4; u8_i++)
    {
        if(u8_path&(1 << u8_i))
        {        
			st_vopss_ss_dev.st_vopss_trigger_mode.u8_trigger_tmg = VDS_TMG1 + u8_i;
			st_vopss_ss_dev.u8_sel = g_dsc_enable[u8Dev] ? g_u8_ss_ch_dsc_idx[u8_i] : g_u8_ss_ch_idx[u8_i];
			api_ss_vopss_trig_mode_cfg(&st_vopss_ss_dev);
        }
    }
    ...
    for(u8_i = 0; u8_i < 4; u8_i++)
    {
        if(u8_path&(1 << u8_i))
        {        
        	st_dma_dev[u8_i].u8_sel = g_dsc_enable[u8Dev] ? g_u8_dma_dsc_idx[u8_i] : g_u8_dma_idx[u8_i];

			api_dma_common_buf_id_get(&st_dma_dev[u8_i]);
			u8_wdma_buf_id[u8Dev] = st_dma_dev[u8_i].st_dma_status.u8_wdma_buf_id;

        	st_dma_dev[u8_i].st_frc_cfg.u8_src_buf_id_sel = (u8_wdma_buf_id[u8Dev] + 1) % 3;
        	st_dma_dev[u8_i].st_frc_cfg.u8_dst_buf_id_sel = (u8_wdma_buf_id[u8Dev] + 0) % 3;
        	api_dma_comom_buf_id_set(&st_dma_dev[u8_i]);
        }
    }
	...
	for(u8_i = 0; u8_i < 4; u8_i++)
    {
        if(u8_path&(1 << u8_i))
        {
            ...
            st_vopss_ss_dev.u8_sel = g_dsc_enable[u8Dev] ? g_u8_ss_ch_dsc_idx[u8_i] : g_u8_ss_ch_idx[u8_i];
            g_u16_timer_out = 0;
            api_misc_int_status_clr(MISC_INTSRC_VDSTMG1VB + u8_i);
            do
            {
                	g_u16_timer_out ++;
                	b_int = api_misc_int_status_get(MISC_INTSRC_VDSTMG1VB + u8_i);
            }
            while((b_int != MS_TRUE) && (g_u16_timer_out < 500));
    ...
    for(u8_i = 0; u8_i < 4; u8_i++)
    {
        if(u8_path&(1 << u8_i))
        {
            gst_single_vipss_dev[u8Dev][u8_i].st_single_com_wdma_dev.u8_sel = g_dsc_enable[u8Dev] ? g_u8_dma_dsc_idx[u8_i] : g_u8_dma_idx[u8_i];
            gst_single_vipss_dev[u8Dev][u8_i].st_single_com_wdma_dev.st_frc_cfg.u8_src_buf_id_mode = DMA_BUF_SWITCH_AUTO;
            gst_single_vipss_dev[u8Dev][u8_i].st_single_com_wdma_dev.st_frc_cfg.u8_dst_buf_id_mode = DMA_BUF_SWITCH_AUTO;
            api_dma_comom_buf_id_mode_cfg(&gst_single_vipss_dev[u8Dev][u8_i].st_single_com_wdma_dev);
        }
    }
    delay_us(50*1000);
    for(u8_i = 0; u8_i < 4; u8_i++)
    {
        if(u8_path&(1 << u8_i))
        {
            ...
            while((b_int != MS_TRUE) && (g_u16_timer_out < 500));
            api_dma_common_trigger(&st_dma_dev[u8_i]);
            b_freeze_status[u8Dev][u8_i] = FALSE;
		}
	}
	__enable_irq();
	...
	for(j=0;j<u8_num;j++)
	{
		...
		for(i=0;i<4;i++)
		{
			if(pu8_path[j]&(1<<i))
			{
				...
				st_dma_dev[i].st_frc_cfg.u8_src_buf_id_sel = (u8_wdma_buf_id[u8StartDev+j] + 0) % 3;
				st_dma_dev[i].st_frc_cfg.u8_dst_buf_id_sel = (u8_wdma_buf_id[u8StartDev+j] + 2) % 3;
...
//    mculib_i2c_write_16bidx8bval(0xb6,0x4004 + u8Tx * 0x100, 0x11);    // once lock
    ...
    Vipss_Mapping_Rx[u8Dev][u8Tx] = u8Rx;
    _single_vipss_cfg(u8Dev,g_dsc_enable[u8Dev],u8Tx);
...
void app_single_win_test(void)
{
    ...
    stMs1826WinTable[0].u8Rx = Vipss_Mapping_Rx[0][0];
    ...
    stMs1826WinTable[1].u8Rx = Vipss_Mapping_Rx[0][1];
    ...
    stMs1826WinTable[2].u8Rx = Vipss_Mapping_Rx[0][2];
    ...
    stMs1826WinTable[3].u8Rx = Vipss_Mapping_Rx[0][3];
...
static VOID app_single_vipss_rx_mux_cfg(UINT8 u8Dev,UINT8 u8_vipss_sel, SINGLE_APP_T *pst_app_single_dev)
{
    ...
    if(g_st_vipss_csc[u8Dev][u8_vipss_sel].st_csc_config_param.csc_in_colorspace == HDMI_COLORSPACE_YCBCR420)
    {
        ...
        api_sdn4k_config(&gst_single_vipss_dev[u8Dev][u8_vipss_sel].st_sdn4k_dev);
        api_sdn4k_enable(&gst_single_vipss_dev[u8Dev][u8_vipss_sel].st_sdn4k_dev, MS_ENABLE);
        g_stVideo_HDMIRx_Timing[u8Dev][u8_vipss_sel].u16_vactive = g_st_hdmi_rx[u8Dev][u8_vipss_sel].st_rx_video_timing.u16_vactive / 2;
    }
    else
    {
        //vipss rx csc config
            ...
            g_st_hdmi_rx[u8Dev][pst_app_single_dev->u8_single_mode].st_rx_video_timing.u8_polarity % 2 == 0)
        {
            switch(g_st_hdmi_rx[u8Dev][pst_app_single_dev->u8_single_mode].st_rx_video_timing.u16_vactive)
            {
                case 1080:
                    ...
                    api_deint_init(&g_st_deint_dev[u8Dev]);
                    api_deint_config(&g_st_deint_dev[u8Dev]);
                    g_stVideo_HDMIRx_Timing[u8Dev][pst_app_single_dev->u8_single_mode].u16_vactive = 1080;
                    break;
                case 480:
                    //vipss mux config
                    api_misc_vipss_mux_cfg(u8_vipss_sel, MISC_VIPSS_MUXTYPE_8);       //< CSC ->DEINT-> SDN -> VWDMA1
                    ...
                    api_deint_init(&g_st_deint_dev[u8Dev]);
                    api_deint_config(&g_st_deint_dev[u8Dev]);
                    g_stVideo_HDMIRx_Timing[u8Dev][pst_app_single_dev->u8_single_mode].u16_hactive = g_st_hdmi_rx[u8Dev][pst_app_single_dev->u8_single_mode].st_rx_video_timing.u16_hactive/2;
                    g_stVideo_HDMIRx_Timing[u8Dev][pst_app_single_dev->u8_single_mode].u16_vactive = 480;
                    break;
                case 576:
                    //vipss mux config
                    api_misc_vipss_mux_cfg(u8_vipss_sel, MISC_VIPSS_MUXTYPE_8);       //< CSC ->DEINT-> SDN -> VWDMA1
                    ...
                    api_deint_config(&g_st_deint_dev[u8Dev]);
                    g_stVideo_HDMIRx_Timing[u8Dev][pst_app_single_dev->u8_single_mode].u16_hactive = g_st_hdmi_rx[u8Dev][pst_app_single_dev->u8_single_mode].st_rx_video_timing.u16_hactive/2;
                    g_stVideo_HDMIRx_Timing[u8Dev][pst_app_single_dev->u8_single_mode].u16_vactive = 576;
                    break;
                default:
                    g_st_deint_dev[u8Dev].b_deint_en = MS_FALSE;
                    api_deint_config(&g_st_deint_dev[u8Dev]);
...
#endif
        {
            if(g_st_hdmi_rx[u8Dev][u8_vipss_sel].st_rx_video_timing.u8_polarity % 2 == 0)
            {
                g_st_deint_dev[u8Dev].b_deint_en = MS_FALSE;
                api_deint_config(&g_st_deint_dev[u8Dev]);
                g_stVideo_HDMIRx_Timing[u8Dev][u8_vipss_sel].u16_hactive = g_st_hdmi_rx[u8Dev][u8_vipss_sel].st_rx_video_timing.u16_hactive;
                g_stVideo_HDMIRx_Timing[u8Dev][u8_vipss_sel].u16_vactive = g_st_hdmi_rx[u8Dev][u8_vipss_sel].st_rx_video_timing.u16_vactive / 2;
...
//    UINT8 u8Rx = pstMs1826WinTable->u8Rx;
    ...
    app_video_vipss_trig(u8Dev,g_dsc_enable[u8Dev]?g_u8_ss_ch_dsc_idx[u8WinID]:g_u8_ss_ch_idx[u8WinID]);
...
//        api_misc_tx_mux_cfg(&g_st_tx_mux[u8Dev][3]);
        ...
        api_hdmi_tx_output_en(&g_st_hdmi_tx[u8Dev][u8Tx],MS_FALSE);
...
static VOID app_single_vopss_splitter_cfg(UINT8 u8Dev,UINT8 u8_vopss_sel, SINGLE_APP_T *pst_app_single_dev)
{
    ...
    //vopss VRDMA config
    gst_single_vopss_dev[u8Dev][u8_vopss_sel].st_single_vrdma_dev.u8_sel = g_dsc_enable[u8Dev]?g_u8_dma_dsc_idx[u8_vopss_sel]:g_u8_dma_idx[u8_vopss_sel];
    gst_single_vopss_dev[u8Dev][u8_vopss_sel].st_single_vrdma_dev.b_enable = MS_FALSE;
    api_vrdma_enable_set(&gst_single_vopss_dev[u8Dev][u8_vopss_sel].st_single_vrdma_dev);
    gst_single_vopss_dev[u8Dev][u8_vopss_sel].st_single_vrdma_dev.u16_request_len = 254;
    api_vrdma_request_len_cfg(&gst_single_vopss_dev[u8Dev][u8_vopss_sel].st_single_vrdma_dev);
	...
	{
		gst_single_vopss_dev[u8Dev][u8_vopss_sel].st_decoder_dev.u8_sel = g_u8_dsc_idx[u8_vopss_sel];
		gst_single_vopss_dev[u8Dev][u8_vopss_sel].st_decoder_dev.st_dsc_config_param.u16_hactive        = gst_single_vopss_dev[u8Dev][u8_vopss_sel].st_single_vrdma_dev.st_vrdma_out_size.u16_h_size;
		gst_single_vopss_dev[u8Dev][u8_vopss_sel].st_decoder_dev.st_dsc_config_param.u16_vactive        = gst_single_vopss_dev[u8Dev][u8_vopss_sel].st_single_vrdma_dev.st_vrdma_out_size.u16_v_size;
		gst_single_vopss_dev[u8Dev][u8_vopss_sel].st_decoder_dev.st_dsc_config_param.u8_color_space     = CHIP_INTERNAL_PROCESS_COLORSPACE;
		gst_single_vopss_dev[u8Dev][u8_vopss_sel].st_decoder_dev.st_dsc_config_param.u8_dsc_ratio       = DSC_RATIO_4X;
		gst_single_vopss_dev[u8Dev][u8_vopss_sel].st_decoder_dev.st_dsc_config_param.u8_dsc_data_path_clk   = PXL_CLK_DIV2;
		api_dsc_decoder_enable(&gst_single_vopss_dev[u8Dev][u8_vopss_sel].st_decoder_dev, MS_TRUE);
    ...
    // su clk src
    st_module_clk.u8_dst_module = g_dsc_enable[u8Dev]?g_u8_misc_dsc_su[u8_vopss_sel]:g_u8_misc_su[u8_vopss_sel];
    st_module_clk.u8_src_clk = MISC_CLKSRC_VDSTMG1;
    st_module_clk.u8_clkdiv = MISC_CLKDIV_1;
    api_misc_su_clkin_sel(&st_module_clk);

    //vopss su config
    gst_single_vopss_dev[u8Dev][u8_vopss_sel].st_single_su_dev.u8_sel = g_dsc_enable[u8Dev]?g_u8_su_dsc_idx[u8_vopss_sel]:g_u8_su_idx[u8_vopss_sel];
    gst_single_vopss_dev[u8Dev][u8_vopss_sel].st_single_su_dev.b_enable = MS_TRUE;
    gst_single_vopss_dev[u8Dev][u8_vopss_sel].st_single_su_dev.u8_su_color_space = CHIP_INTERNAL_PROCESS_COLORSPACE;
...
static VOID app_single_vipss_splitter_cfg(UINT8 u8Dev,UINT8 u8_vipss_sel, SINGLE_APP_T *pst_app_single_dev)
{
    ...
    //vipss vwdma config
    gst_single_vipss_dev[u8Dev][u8_vipss_sel].st_single_vwdma_dev.u8_sel = g_dsc_enable[u8Dev]?g_u8_dma_dsc_idx[u8_vipss_sel]:g_u8_dma_idx[u8_vipss_sel];
    gst_single_vipss_dev[u8Dev][u8_vipss_sel].st_single_vwdma_dev.b_enable = MS_FALSE;
    api_vwdma_enable_set(&gst_single_vipss_dev[u8Dev][u8_vipss_sel].st_single_vwdma_dev);
    gst_single_vipss_dev[u8Dev][u8_vipss_sel].st_single_vwdma_dev.u16_request_len = 254;
    api_vwdma_request_len_cfg(&gst_single_vipss_dev[u8Dev][u8_vipss_sel].st_single_vwdma_dev);
...
//    app_splitter_vipss_rx_mux_cfg(u8Dev,VIPSS1+u8Rx, pst_app_signle_dev);
    //scale size
    pst_app_signle_dev->st_scale_size.tInSize.u16_h = g_stVideo_HDMIRx_Timing[u8Dev][Vipss_Mapping_Rx[u8Dev][u8WinID]].u16_hactive;
    pst_app_signle_dev->st_scale_size.tInSize.u16_v = g_stVideo_HDMIRx_Timing[u8Dev][Vipss_Mapping_Rx[u8Dev][u8WinID]].u16_vactive;
    ...
    LOG("st_scale_size[%d].tInSize.u16_h == 0x%08x\r\n",u8WinID,pst_app_signle_dev->st_scale_size.tInSize.u16_h);
    LOG("st_scale_size[%d].tInSize.u16_h == 0x%08x\r\n",u8WinID,pst_app_signle_dev->st_scale_size.tInSize.u16_v);
    LOG("st_scale_size[%d].tOutSize.u16_h == 0x%08x\r\n",u8WinID,pst_app_signle_dev->st_scale_size.tOutSize.u16_h);
    LOG("st_scale_size[%d].tOutSize.u16_v == 0x%08x\r\n",u8WinID,pst_app_signle_dev->st_scale_size.tOutSize.u16_v);
    LOG("st_scale_size[%d].tMemSize.u16_h == 0x%08x\r\n",u8WinID,pst_app_signle_dev->st_scale_size.tMemSize.u16_h);
    LOG("st_scale_size[%d].tMemSize.u16_v == 0x%08x\r\n",u8WinID,pst_app_signle_dev->st_scale_size.tMemSize.u16_v);

    LOG("st_video_win[%d].u16_hde_st == 0x%08x\r\n",u8WinID,pst_app_signle_dev->st_video_win.u16_hde_st);
    LOG("st_video_win[%d].u16_hde_sp == 0x%08x\r\n",u8WinID,pst_app_signle_dev->st_video_win.u16_hde_sp);
    LOG("st_video_win[%d].u16_vde_st == 0x%08x\r\n",u8WinID,pst_app_signle_dev->st_video_win.u16_vde_st);
    LOG("st_video_win[%d].u16_vde_sp == 0x%08x\r\n",u8WinID,pst_app_signle_dev->st_video_win.u16_vde_sp);

    LOG("st_dma_addr[%d].u32_dma_start_addr_0 == 0x%08x\r\n",u8WinID,pst_app_signle_dev->st_dma_addr.u32_dma_start_addr_0);
    LOG("st_dma_addr[%d].u32_dma_start_addr_1 == 0x%08x\r\n",u8WinID,pst_app_signle_dev->st_dma_addr.u32_dma_start_addr_1);
    LOG("st_dma_addr[%d].u32_dma_start_addr_2 == 0x%08x\r\n",u8WinID,pst_app_signle_dev->st_dma_addr.u32_dma_start_addr_2);
    if(bUpdate)
    {
//        _single_vipss_cfg(u8Dev,bIsDsc,VIPSS1+u8Rx);
...
void app_single_user_splitter_process(UINT8 u8Dev,UINT8 u8_rx_idx)
{
    app_single_vipss_rx_mux_cfg(u8Dev,VIPSS1+u8_rx_idx,&g_st_single_app_dev[u8Dev][u8_rx_idx]);
    g_st_single_app_dev[u8Dev][u8_rx_idx].st_scale_size.tInSize.u16_h = g_stVideo_HDMIRx_Timing[u8Dev][Vipss_Mapping_Rx[u8Dev][u8_rx_idx]].u16_hactive;
    g_st_single_app_dev[u8Dev][u8_rx_idx].st_scale_size.tInSize.u16_v = g_stVideo_HDMIRx_Timing[u8Dev][Vipss_Mapping_Rx[u8Dev][u8_rx_idx]].u16_vactive;
#if 0
    g_st_single_app_dev[u8Dev][u8_rx_idx].st_scale_size[u8_rx_idx].tOutSize.u16_h =
            (((g_stMs1826WinTable[u8Dev][u8_rx_idx].u16W>g_stVideo_HDMITx_Timing[u8Dev][g_st_single_app_dev[u8Dev][u8_rx_idx].u8_dst_sel].u16_hactive))
            ?(g_stVideo_HDMITx_Timing[u8Dev][g_st_single_app_dev[u8Dev][u8_rx_idx].u8_dst_sel].u16_hactive):(g_stMs1826WinTable[u8Dev][u8_rx_idx].u16W));
    g_st_single_app_dev[u8Dev][u8_rx_idx].st_scale_size[u8_rx_idx].tOutSize.u16_v =
            (((g_stMs1826WinTable[u8Dev][u8_rx_idx].u16H>g_stVideo_HDMITx_Timing[u8Dev][g_st_single_app_dev[u8Dev][u8_rx_idx].u8_dst_sel].u16_vactive))
            ?(g_stVideo_HDMITx_Timing[u8Dev][g_st_single_app_dev[u8Dev][u8_rx_idx].u8_dst_sel].u16_vactive):(g_stMs1826WinTable[u8Dev][u8_rx_idx].u16H));
#endif
    g_st_single_app_dev[u8Dev][u8_rx_idx].st_scale_size.tMemSize.u16_h = return_minof_three(g_stVideo_HDMIRx_Timing[u8Dev][Vipss_Mapping_Rx[u8Dev][u8_rx_idx]].u16_hactive, g_st_single_app_dev[u8Dev][u8_rx_idx].st_scale_size.tOutSize.u16_h, MEMORY_1080P_H_SIZE_MAX);
    g_st_single_app_dev[u8Dev][u8_rx_idx].st_scale_size.tMemSize.u16_v = return_minof_three(g_stVideo_HDMIRx_Timing[u8Dev][Vipss_Mapping_Rx[u8Dev][u8_rx_idx]].u16_vactive, g_st_single_app_dev[u8Dev][u8_rx_idx].st_scale_size.tOutSize.u16_v, MEMORY_1080P_V_SIZE_MAX);

    LOG("2 st_scale_size[%d].tInSize.u16_h  == 0x%08x\r\n",u8_rx_idx,g_st_single_app_dev[u8Dev][u8_rx_idx].st_scale_size.tInSize.u16_h);
    LOG("2 st_scale_size[%d].tInSize.u16_h  == 0x%08x\r\n",u8_rx_idx,g_st_single_app_dev[u8Dev][u8_rx_idx].st_scale_size.tInSize.u16_v);
    LOG("2 st_scale_size[%d].tOutSize.u16_h == 0x%08x\r\n",u8_rx_idx,g_st_single_app_dev[u8Dev][u8_rx_idx].st_scale_size.tOutSize.u16_h);
    LOG("2 st_scale_size[%d].tOutSize.u16_v == 0x%08x\r\n",u8_rx_idx,g_st_single_app_dev[u8Dev][u8_rx_idx].st_scale_size.tOutSize.u16_v);
    LOG("2 st_scale_size[%d].tMemSize.u16_h == 0x%08x\r\n",u8_rx_idx,g_st_single_app_dev[u8Dev][u8_rx_idx].st_scale_size.tMemSize.u16_h);
    LOG("2 st_scale_size[%d].tMemSize.u16_v == 0x%08x\r\n",u8_rx_idx,g_st_single_app_dev[u8Dev][u8_rx_idx].st_scale_size.tMemSize.u16_v);

    LOG("2 st_video_win[%d].u16_hde_st == 0x%08x\r\n",u8_rx_idx,g_st_single_app_dev[u8Dev][u8_rx_idx].st_video_win.u16_hde_st);
    LOG("2 st_video_win[%d].u16_hde_sp == 0x%08x\r\n",u8_rx_idx,g_st_single_app_dev[u8Dev][u8_rx_idx].st_video_win.u16_hde_sp);
    LOG("2 st_video_win[%d].u16_vde_st == 0x%08x\r\n",u8_rx_idx,g_st_single_app_dev[u8Dev][u8_rx_idx].st_video_win.u16_vde_st);
    LOG("2 st_video_win[%d].u16_vde_sp == 0x%08x\r\n",u8_rx_idx,g_st_single_app_dev[u8Dev][u8_rx_idx].st_video_win.u16_vde_sp);

    LOG("2 st_dma_addr[%d].u32_dma_start_addr_0 == 0x%08x\r\n",u8_rx_idx,g_st_single_app_dev[u8Dev][u8_rx_idx].st_dma_addr.u32_dma_start_addr_0);
    LOG("2 st_dma_addr[%d].u32_dma_start_addr_1 == 0x%08x\r\n",u8_rx_idx,g_st_single_app_dev[u8Dev][u8_rx_idx].st_dma_addr.u32_dma_start_addr_1);
    LOG("2 st_dma_addr[%d].u32_dma_start_addr_2 == 0x%08x\r\n",u8_rx_idx,g_st_single_app_dev[u8Dev][u8_rx_idx].st_dma_addr.u32_dma_start_addr_2);

    //vipss sdn config
    gst_single_vipss_dev[u8Dev][u8_rx_idx].st_single_sdn_dev.st_video_size.st_InRect.u16_h = g_st_single_app_dev[u8Dev][u8_rx_idx].st_scale_size.tInSize.u16_h;
    gst_single_vipss_dev[u8Dev][u8_rx_idx].st_single_sdn_dev.st_video_size.st_InRect.u16_v = g_st_single_app_dev[u8Dev][u8_rx_idx].st_scale_size.tInSize.u16_v;
    gst_single_vipss_dev[u8Dev][u8_rx_idx].st_single_sdn_dev.st_video_size.st_MemRect.u16_h = g_st_single_app_dev[u8Dev][u8_rx_idx].st_scale_size.tMemSize.u16_h;
    gst_single_vipss_dev[u8Dev][u8_rx_idx].st_single_sdn_dev.st_video_size.st_MemRect.u16_v = g_st_single_app_dev[u8Dev][u8_rx_idx].st_scale_size.tMemSize.u16_v;

    api_sdn_scaler_size_set(&gst_single_vipss_dev[u8Dev][u8_rx_idx].st_single_sdn_dev);
	
	if(g_dsc_enable[u8Dev])
	{
		//vipss dsc config
		gst_single_vipss_dev[u8Dev][u8_rx_idx].st_encoder_dev.u8_sel = g_u8_dsc_idx[u8_rx_idx];
		gst_single_vipss_dev[u8Dev][u8_rx_idx].st_encoder_dev.st_dsc_config_param.u16_hactive = gst_single_vipss_dev[u8Dev][u8_rx_idx].st_single_sdn_dev.st_video_size.st_MemRect.u16_h;
		gst_single_vipss_dev[u8Dev][u8_rx_idx].st_encoder_dev.st_dsc_config_param.u16_vactive = gst_single_vipss_dev[u8Dev][u8_rx_idx].st_single_sdn_dev.st_video_size.st_MemRect.u16_v;
		api_dsc_encoder_set(&gst_single_vipss_dev[u8Dev][u8_rx_idx].st_encoder_dev);
	}
			
    //vipss vwdma config
    gst_single_vipss_dev[u8Dev][u8_rx_idx].st_single_vwdma_dev.st_vwdma_in_size.u16_h_size = g_st_single_app_dev[u8Dev][u8_rx_idx].st_scale_size.tMemSize.u16_h;
    gst_single_vipss_dev[u8Dev][u8_rx_idx].st_single_vwdma_dev.st_vwdma_in_size.u16_v_size = g_st_single_app_dev[u8Dev][u8_rx_idx].st_scale_size.tMemSize.u16_v;
    gst_single_vipss_dev[u8Dev][u8_rx_idx].st_single_vwdma_dev.u16_line_offset = g_st_single_app_dev[u8Dev][u8_rx_idx].st_scale_size.tMemSize.u16_h;

    gst_single_vipss_dev[u8Dev][u8_rx_idx].st_single_vwdma_dev.st_vwdma_start_addr.u32_dma_start_addr_0 = g_st_single_app_dev[u8Dev][u8_rx_idx].st_dma_addr.u32_dma_start_addr_0;
    gst_single_vipss_dev[u8Dev][u8_rx_idx].st_single_vwdma_dev.st_vwdma_start_addr.u32_dma_start_addr_1 = g_st_single_app_dev[u8Dev][u8_rx_idx].st_dma_addr.u32_dma_start_addr_1;
    gst_single_vipss_dev[u8Dev][u8_rx_idx].st_single_vwdma_dev.st_vwdma_start_addr.u32_dma_start_addr_2 = g_st_single_app_dev[u8Dev][u8_rx_idx].st_dma_addr.u32_dma_start_addr_2;
    api_vwdma_start_addr_cfg(&gst_single_vipss_dev[u8Dev][u8_rx_idx].st_single_vwdma_dev);
    api_vwdma_line_offset_cfg(&gst_single_vipss_dev[u8Dev][u8_rx_idx].st_single_vwdma_dev);
    api_vwdma_burst_num_cfg(&gst_single_vipss_dev[u8Dev][u8_rx_idx].st_single_vwdma_dev);


     //vopss VRDMA config
    gst_single_vopss_dev[u8Dev][u8_rx_idx].st_single_vrdma_dev.b_enable = MS_TRUE;
    gst_single_vopss_dev[u8Dev][u8_rx_idx].st_single_vrdma_dev.u16_line_offset = g_st_single_app_dev[u8Dev][u8_rx_idx].st_scale_size.tMemSize.u16_h;
    gst_single_vopss_dev[u8Dev][u8_rx_idx].st_single_vrdma_dev.st_vrdma_out_size.u16_h_size = g_st_single_app_dev[u8Dev][u8_rx_idx].st_scale_size.tMemSize.u16_h;
    gst_single_vopss_dev[u8Dev][u8_rx_idx].st_single_vrdma_dev.st_vrdma_out_size.u16_v_size = g_st_single_app_dev[u8Dev][u8_rx_idx].st_scale_size.tMemSize.u16_v;
    gst_single_vopss_dev[u8Dev][u8_rx_idx].st_single_vrdma_dev.st_vrdma_start_addr.u32_dma_start_addr_0 = g_st_single_app_dev[u8Dev][u8_rx_idx].st_dma_addr.u32_dma_start_addr_0;
    gst_single_vopss_dev[u8Dev][u8_rx_idx].st_single_vrdma_dev.st_vrdma_start_addr.u32_dma_start_addr_1 = g_st_single_app_dev[u8Dev][u8_rx_idx].st_dma_addr.u32_dma_start_addr_1;
    gst_single_vopss_dev[u8Dev][u8_rx_idx].st_single_vrdma_dev.st_vrdma_start_addr.u32_dma_start_addr_2 = g_st_single_app_dev[u8Dev][u8_rx_idx].st_dma_addr.u32_dma_start_addr_2;

    api_vrdma_enable_set(&gst_single_vopss_dev[u8Dev][u8_rx_idx].st_single_vrdma_dev);
    api_vrdma_start_addr_cfg(&gst_single_vopss_dev[u8Dev][u8_rx_idx].st_single_vrdma_dev);
    api_vrdma_burst_num_cfg(&gst_single_vopss_dev[u8Dev][u8_rx_idx].st_single_vrdma_dev);
    api_vrdma_line_offset_cfg(&gst_single_vopss_dev[u8Dev][u8_rx_idx].st_single_vrdma_dev);
	
	if(g_dsc_enable[u8Dev])
	{
		// vopss dsc config
        gst_single_vopss_dev[u8Dev][u8_rx_idx].st_decoder_dev.st_dsc_config_param.u16_hactive = gst_single_vipss_dev[u8Dev][u8_rx_idx].st_single_vwdma_dev.st_vwdma_in_size.u16_h_size;
        gst_single_vopss_dev[u8Dev][u8_rx_idx].st_decoder_dev.st_dsc_config_param.u16_vactive = gst_single_vipss_dev[u8Dev][u8_rx_idx].st_single_vwdma_dev.st_vwdma_in_size.u16_v_size;
		api_dsc_decoder_set(&gst_single_vopss_dev[u8Dev][u8_rx_idx].st_decoder_dev);
	}

    //vopss su config
    gst_single_vopss_dev[u8Dev][u8_rx_idx].st_single_su_dev.st_video_size.st_MemRect.u16_h = g_st_single_app_dev[u8Dev][u8_rx_idx].st_scale_size.tMemSize.u16_h;
    gst_single_vopss_dev[u8Dev][u8_rx_idx].st_single_su_dev.st_video_size.st_MemRect.u16_v = g_st_single_app_dev[u8Dev][u8_rx_idx].st_scale_size.tMemSize.u16_v;
    api_su_scaler_size_set(&gst_single_vopss_dev[u8Dev][u8_rx_idx].st_single_su_dev);

    app_video_vipss_trig(u8Dev,g_dsc_enable[u8Dev]?g_u8_ss_ch_dsc_idx[u8_rx_idx]:g_u8_ss_ch_idx[u8_rx_idx]);
    app_video_vopss_trig(u8Dev,g_dsc_enable[u8Dev]?g_u8_ss_ch_dsc_idx[u8_rx_idx]:g_u8_ss_ch_idx[u8_rx_idx]);
    mculib_delay_ms(200);
...
void app_single_user_splitter_mode_test(void)
{
    ...
    stMs1826WinTable[2].u8Rx = Vipss_Mapping_Rx[0][1];
