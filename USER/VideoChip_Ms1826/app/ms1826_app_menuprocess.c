...
VOID app_osd_info_cfg(UINT8 u8Dev)
{
    ...
    st_osd_showfonts.u8_y = 1;
    st_osd_showfonts.u16_idx = STR_MODE_CN[g_u8_display_mode[u8Dev]];
    st_osd_showfonts.u8_len = sizeof(STR_MODE_CN[g_u8_display_mode[u8Dev]])/sizeof(STR_MODE_CN[g_u8_display_mode[u8Dev]][0]);
    app_osd_show_fonts(&st_osd_showfonts);
