...
#if (MS1826_SPLITTER_USER_MODE_ENABLE==0)
        if(pst_app_splitter_dev->u8_splitter_mode < MODE_DUAL_UP1_DOWN2)
            g_stVideo_HDMIRx_Timing[u8Dev][pst_app_splitter_dev->u8_splitter_mode].u16_vactive = g_st_hdmi_rx[u8Dev][pst_app_splitter_dev->u8_splitter_mode].st_rx_video_timing.u16_vactive / 2;
        else
#endif
            ...
            g_st_hdmi_rx[u8Dev][pst_app_splitter_dev->u8_splitter_mode].st_rx_video_timing.u8_polarity % 2 == 0)
        {
            switch(g_st_hdmi_rx[u8Dev][pst_app_splitter_dev->u8_splitter_mode].st_rx_video_timing.u16_vactive)
            {
                case 1080:
                    ...
                    g_stVideo_HDMIRx_Timing[u8Dev][pst_app_splitter_dev->u8_splitter_mode].u16_vactive = 1080;
                    break;
                case 480:
                    //vipss mux config
                    api_misc_vipss_mux_cfg(u8_vipss_sel, MISC_VIPSS_MUXTYPE_8);       //< CSC ->DEINT-> SDN -> VWDMA1
                    ...
                    api_deint_init(&g_st_deint_dev[u8Dev]);
                    api_deint_config(&g_st_deint_dev[u8Dev]);
                    g_stVideo_HDMIRx_Timing[u8Dev][pst_app_splitter_dev->u8_splitter_mode].u16_hactive = g_st_hdmi_rx[u8Dev][pst_app_splitter_dev->u8_splitter_mode].st_rx_video_timing.u16_hactive/2;
                    g_stVideo_HDMIRx_Timing[u8Dev][pst_app_splitter_dev->u8_splitter_mode].u16_vactive = 480;
                    break;
                case 576:
                    //vipss mux config
                    api_misc_vipss_mux_cfg(u8_vipss_sel, MISC_VIPSS_MUXTYPE_8);       //< CSC ->DEINT-> SDN -> VWDMA1
                    ...
                    api_deint_config(&g_st_deint_dev[u8Dev]);
                    g_stVideo_HDMIRx_Timing[u8Dev][pst_app_splitter_dev->u8_splitter_mode].u16_hactive = g_st_hdmi_rx[u8Dev][pst_app_splitter_dev->u8_splitter_mode].st_rx_video_timing.u16_hactive/2;
                    g_stVideo_HDMIRx_Timing[u8Dev][pst_app_splitter_dev->u8_splitter_mode].u16_vactive = 576;
                    break;
                default:
...
static VOID app_splitter_vipss_cfg(UINT8 u8Dev,UINT8 u8_vipss_sel, SPLITTER_APP_T *pst_app_splitter_dev)
{
    ...
    gst_splitter_vipss_dev[u8Dev][u8_vipss_sel].st_splitter_vwdma_dev.b_enable = MS_FALSE;
...
static VOID app_splitter_vopss_cfg(UINT8 u8Dev,UINT8 u8_vopss_sel, SPLITTER_APP_T *pst_app_splitter_dev)
{
    ...
    gst_splitter_vopss_dev[u8Dev][u8_vopss_sel].st_splitter_vrdma_dev.b_enable = MS_FALSE;
...
static VOID _splitter_mode_frc_cfg(UINT8 u8Dev)
{
    ...
    gst_splitter_vopss_dev[u8Dev][VOPSS1].st_splitter_com_rdma_dev.st_frc_cfg.b_frc_ctl_ext = MS_FALSE;
    ...
    gst_splitter_vopss_dev[u8Dev][VOPSS2].st_splitter_com_rdma_dev.st_frc_cfg.b_frc_ctl_ext = MS_FALSE;
    ...
    gst_splitter_vopss_dev[u8Dev][VOPSS3].st_splitter_com_rdma_dev.st_frc_cfg.b_frc_ctl_ext = MS_FALSE;
    ...
    gst_splitter_vopss_dev[u8Dev][VOPSS4].st_splitter_com_rdma_dev.st_frc_cfg.b_frc_ctl_ext = MS_FALSE;
...
VOID _splitter_video_unfreeze(UINT8 u8Dev)
{
    ...
    st_dma_dev.st_frc_cfg.u8_src_buf_id_sel = (u8_wdma_buf_id[u8Dev] + 1) % 3;
    st_dma_dev.st_frc_cfg.u8_dst_buf_id_sel = u8_wdma_buf_id[u8Dev];
    api_dma_comom_buf_id_set(&st_dma_dev);
    ...
    {
        st_dma_dev.st_frc_cfg.u8_src_buf_id_sel = (u8_wdma_buf_id[u8Dev] + 2) % 3;
        st_dma_dev.st_frc_cfg.u8_dst_buf_id_sel = u8_wdma_buf_id[u8Dev];
        api_dma_comom_buf_id_set(&st_dma_dev);
    }
...
VOID app_splitter_mode_config(UINT8 u8Dev,SPLITTER_APP_T *pst_app_splitter_dev)
{
    ...
    for(u8_i = 0; u8_i < 4; u8_i ++)
    {
        ...
        {
            Bypass_Tx_Status[u8Dev][u8_i] = MS_FALSE;
        }
        else
...
//        api_misc_tx_mux_cfg(&g_st_tx_mux[u8Dev][pst_app_splitter_dev->u8_dst_sel]);
        ...
        api_hdmi_tx_output_en(&g_st_hdmi_tx[u8Dev][pst_app_splitter_dev->u8_dst_sel],MS_FALSE);
    ...
    switch(pst_app_splitter_dev->u8_splitter_mode)
    {
        ...
        case MODE_SIGNLE_4:
            ...
            //scale size
            pst_app_splitter_dev->st_scale_size[0].tInSize.u16_h = g_stVideo_HDMIRx_Timing[u8Dev][pst_app_splitter_dev->u8_splitter_mode].u16_hactive;
            pst_app_splitter_dev->st_scale_size[0].tInSize.u16_v = g_stVideo_HDMIRx_Timing[u8Dev][pst_app_splitter_dev->u8_splitter_mode].u16_vactive;
        ...
        case MODE_DUAL_UP1_DOWN2:
            ...
            //scale size
            pst_app_splitter_dev->st_scale_size[0].tInSize.u16_h = g_stVideo_HDMIRx_Timing[u8Dev][g_u8SplitterDispMapping[u8Dev][0]].u16_hactive;
            pst_app_splitter_dev->st_scale_size[0].tInSize.u16_v = g_stVideo_HDMIRx_Timing[u8Dev][g_u8SplitterDispMapping[u8Dev][0]].u16_vactive;
            pst_app_splitter_dev->st_scale_size[0].tOutSize.u16_h = g_stVideo_HDMITx_Timing[u8Dev][g_st_app_splitter_dev[u8Dev].u8_dst_sel].u16_hactive;
            ...
            pst_app_splitter_dev->st_scale_size[1].tInSize.u16_h = g_stVideo_HDMIRx_Timing[u8Dev][g_u8SplitterDispMapping[u8Dev][1]].u16_hactive;
            pst_app_splitter_dev->st_scale_size[1].tInSize.u16_v = g_stVideo_HDMIRx_Timing[u8Dev][g_u8SplitterDispMapping[u8Dev][1]].u16_vactive;
        ...
        case MODE_DUAL_UP3_DOWN4:
            ...
            //scale size
            pst_app_splitter_dev->st_scale_size[2].tInSize.u16_h = g_stVideo_HDMIRx_Timing[u8Dev][g_u8SplitterDispMapping[u8Dev][2]].u16_hactive;
            pst_app_splitter_dev->st_scale_size[2].tInSize.u16_v = g_stVideo_HDMIRx_Timing[u8Dev][g_u8SplitterDispMapping[u8Dev][2]].u16_vactive;
            ...
            pst_app_splitter_dev->st_scale_size[3].tInSize.u16_h = g_stVideo_HDMIRx_Timing[u8Dev][g_u8SplitterDispMapping[u8Dev][3]].u16_hactive;
            pst_app_splitter_dev->st_scale_size[3].tInSize.u16_v = g_stVideo_HDMIRx_Timing[u8Dev][g_u8SplitterDispMapping[u8Dev][3]].u16_vactive;
    ...
    sys_show_osd(u8Dev,g_bOSDShown[u8Dev], 0x01);
}
#endif
#if MS1826_SPLITTER_USER_MODE_ENABLE
VOID app_splitter_process(UINT8 u8Dev,UINT8 u8_rx_idx)
{
    app_splitter_user_process(u8Dev,u8_rx_idx);
}
#else
VOID app_splitter_process(UINT8 u8Dev,UINT8 u8_rx_idx)
{
    switch(g_st_app_splitter_dev[u8Dev].u8_splitter_mode)
    {
        ...
        case MODE_SIGNLE_4:
            //scale size
            if(u8_rx_idx == g_st_app_splitter_dev[u8Dev].u8_splitter_mode)
            {
                app_splitter_vipss_rx_mux_cfg(u8Dev,VIPSS1, &g_st_app_splitter_dev[u8Dev]);
                g_st_app_splitter_dev[u8Dev].st_scale_size[0].tInSize.u16_h = g_stVideo_HDMIRx_Timing[u8Dev][u8_rx_idx].u16_hactive;
                g_st_app_splitter_dev[u8Dev].st_scale_size[0].tInSize.u16_v = g_stVideo_HDMIRx_Timing[u8Dev][u8_rx_idx].u16_vactive;
        ...
        case MODE_DUAL_UP1_DOWN2:
            ...
            {
                app_splitter_vipss_rx_mux_cfg(u8Dev,u8_rx_idx, &g_st_app_splitter_dev[u8Dev]);
                //scale size
                g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tInSize.u16_h = g_stVideo_HDMIRx_Timing[u8Dev][g_u8SplitterDispMapping[u8Dev][u8_rx_idx]].u16_hactive;
                g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tInSize.u16_v = g_stVideo_HDMIRx_Timing[u8Dev][g_u8SplitterDispMapping[u8Dev][u8_rx_idx]].u16_vactive;
                g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tOutSize.u16_h = g_stVideo_HDMITx_Timing[u8Dev][g_st_app_splitter_dev[u8Dev].u8_dst_sel].u16_hactive;
                g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tOutSize.u16_v = g_stVideo_HDMITx_Timing[u8Dev][g_st_app_splitter_dev[u8Dev].u8_dst_sel].u16_vactive / 2;
                g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tMemSize.u16_h = return_minof_three(g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tInSize.u16_h, g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tOutSize.u16_h, MEMORY_1080P_H_SIZE_MAX);
                g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tMemSize.u16_v = return_minof_three(g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tInSize.u16_v, g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tOutSize.u16_v, MEMORY_1080P_V_SIZE_MAX);
            }
            else
            {
                return;
        ...
        case MODE_DUAL_UP1_DOWN2_4_3:
            if(u8_rx_idx == 0 || u8_rx_idx == 1)
            {
                ...
                g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tInSize.u16_h = g_stVideo_HDMIRx_Timing[u8Dev][g_u8SplitterDispMapping[u8Dev][u8_rx_idx]].u16_hactive;
                g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tInSize.u16_v = g_stVideo_HDMIRx_Timing[u8Dev][g_u8SplitterDispMapping[u8Dev][u8_rx_idx]].u16_vactive;
                g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tOutSize.u16_h = g_stVideo_HDMITx_Timing[u8Dev][g_st_app_splitter_dev[u8Dev].u8_dst_sel].u16_vactive / 2 * 4 / 3;
                g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tOutSize.u16_v = g_stVideo_HDMITx_Timing[u8Dev][g_st_app_splitter_dev[u8Dev].u8_dst_sel].u16_vactive / 2;
                g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tMemSize.u16_h = return_minof_three(g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tInSize.u16_h, g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tOutSize.u16_h, MEMORY_1080P_H_SIZE_MAX);
                g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tMemSize.u16_v = return_minof_three(g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tInSize.u16_v, g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tOutSize.u16_v, MEMORY_1080P_V_SIZE_MAX);
            }
        ...
        case MODE_DUAL_LEFT1_RIGHT2:
            if(u8_rx_idx == 0 || u8_rx_idx == 1)
            {
                ...
                g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tInSize.u16_h = g_stVideo_HDMIRx_Timing[u8Dev][g_u8SplitterDispMapping[u8Dev][u8_rx_idx]].u16_hactive;
                g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tInSize.u16_v = g_stVideo_HDMIRx_Timing[u8Dev][g_u8SplitterDispMapping[u8Dev][u8_rx_idx]].u16_vactive;
                g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tOutSize.u16_h = g_stVideo_HDMITx_Timing[u8Dev][g_st_app_splitter_dev[u8Dev].u8_dst_sel].u16_hactive / 2;
                g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tOutSize.u16_v = g_stVideo_HDMITx_Timing[u8Dev][g_st_app_splitter_dev[u8Dev].u8_dst_sel].u16_vactive;
                g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tMemSize.u16_h = return_minof_three(g_stVideo_HDMIRx_Timing[u8Dev][g_u8SplitterDispMapping[u8Dev][u8_rx_idx]].u16_hactive, g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tOutSize.u16_h, MEMORY_1080P_H_SIZE_MAX);
                g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tMemSize.u16_v = return_minof_three(g_stVideo_HDMIRx_Timing[u8Dev][g_u8SplitterDispMapping[u8Dev][u8_rx_idx]].u16_vactive, g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tOutSize.u16_v, MEMORY_1080P_V_SIZE_MAX);
            }
            else
            {
                return;
        ...
        case MODE_DUAL_LEFT1_RIGHT2_4_3:
            if(u8_rx_idx == 0 || u8_rx_idx == 1)
            {
                ...
                g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tInSize.u16_v = g_stVideo_HDMIRx_Timing[u8Dev][g_u8SplitterDispMapping[u8Dev][u8_rx_idx]].u16_vactive;
                g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tOutSize.u16_h = g_stVideo_HDMITx_Timing[u8Dev][g_st_app_splitter_dev[u8Dev].u8_dst_sel].u16_hactive / 2;
                g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tOutSize.u16_v = g_stVideo_HDMITx_Timing[u8Dev][g_st_app_splitter_dev[u8Dev].u8_dst_sel].u16_hactive / 2 / 4 * 3;
                g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tMemSize.u16_h = return_minof_three(g_stVideo_HDMIRx_Timing[u8Dev][g_u8SplitterDispMapping[u8Dev][u8_rx_idx]].u16_hactive, g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tOutSize.u16_h, MEMORY_1080P_H_SIZE_MAX);
                g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tMemSize.u16_v = return_minof_three(g_stVideo_HDMIRx_Timing[u8Dev][g_u8SplitterDispMapping[u8Dev][u8_rx_idx]].u16_vactive, g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tOutSize.u16_v, MEMORY_1080P_V_SIZE_MAX);
            }
            else
        ...
        case MODE_PIP_12_1_3:
            ...
            else if(u8_rx_idx == 1)
            {
                ...
                g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tInSize.u16_h = g_stVideo_HDMIRx_Timing[u8Dev][g_u8SplitterDispMapping[u8Dev][u8_rx_idx]].u16_hactive;
                g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tInSize.u16_v = g_stVideo_HDMIRx_Timing[u8Dev][g_u8SplitterDispMapping[u8Dev][u8_rx_idx]].u16_vactive;
                g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tOutSize.u16_h = g_stVideo_HDMITx_Timing[u8Dev][g_st_app_splitter_dev[u8Dev].u8_dst_sel].u16_hactive / 3;
                g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tOutSize.u16_v = g_stVideo_HDMITx_Timing[u8Dev][g_st_app_splitter_dev[u8Dev].u8_dst_sel].u16_vactive / 3;
                g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tMemSize.u16_h = return_minof_three(g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tInSize.u16_h, g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tOutSize.u16_h, MEMORY_1080P_H_SIZE_MAX);
                g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tMemSize.u16_v = return_minof_three(g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tInSize.u16_v, g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tOutSize.u16_v, MEMORY_1080P_V_SIZE_MAX);
            }
            else
        ...
        case MODE_FOUR_MAIN3_SUB124:
        case MODE_FOUR_MAIN4_SUB123:
            if(u8_rx_idx == g_st_app_splitter_dev[u8Dev].u8_splitter_mode - MODE_FOUR_MAIN1_SUB234)
            {
                app_splitter_vipss_rx_mux_cfg(u8Dev,u8_rx_idx, &g_st_app_splitter_dev[u8Dev]);
                g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tInSize.u16_h = g_stVideo_HDMIRx_Timing[u8Dev][g_u8SplitterDispMapping[u8Dev][u8_rx_idx]].u16_hactive;
                g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tInSize.u16_v = g_stVideo_HDMIRx_Timing[u8Dev][g_u8SplitterDispMapping[u8Dev][u8_rx_idx]].u16_vactive;
                g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tOutSize.u16_h = g_stVideo_HDMITx_Timing[u8Dev][g_st_app_splitter_dev[u8Dev].u8_dst_sel].u16_hactive / 3 * 2;
                g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tOutSize.u16_v = g_stVideo_HDMITx_Timing[u8Dev][g_st_app_splitter_dev[u8Dev].u8_dst_sel].u16_vactive;
                g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tMemSize.u16_h = return_minof_three(g_stVideo_HDMIRx_Timing[u8Dev][g_u8SplitterDispMapping[u8Dev][u8_rx_idx]].u16_hactive, g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tOutSize.u16_h, MEMORY_1080P_H_SIZE_MAX);
                g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tMemSize.u16_v = return_minof_three(g_stVideo_HDMIRx_Timing[u8Dev][g_u8SplitterDispMapping[u8Dev][u8_rx_idx]].u16_vactive, g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tOutSize.u16_v, MEMORY_1080P_V_SIZE_MAX);
            }
    ...
    //vipss sdn config
    gst_splitter_vipss_dev[u8Dev][u8_rx_idx].st_splitter_sdn_dev.st_video_size.st_InRect.u16_h = g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tInSize.u16_h;
    gst_splitter_vipss_dev[u8Dev][u8_rx_idx].st_splitter_sdn_dev.st_video_size.st_InRect.u16_v = g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tInSize.u16_v;
    gst_splitter_vipss_dev[u8Dev][u8_rx_idx].st_splitter_sdn_dev.st_video_size.st_MemRect.u16_h = g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tMemSize.u16_h;
    gst_splitter_vipss_dev[u8Dev][u8_rx_idx].st_splitter_sdn_dev.st_video_size.st_MemRect.u16_v = g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tMemSize.u16_v;

    api_sdn_scaler_size_set(&gst_splitter_vipss_dev[u8Dev][u8_rx_idx].st_splitter_sdn_dev);
    //vipss vwdma config
    gst_splitter_vipss_dev[u8Dev][u8_rx_idx].st_splitter_vwdma_dev.st_vwdma_in_size.u16_h_size = g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tMemSize.u16_h;
    gst_splitter_vipss_dev[u8Dev][u8_rx_idx].st_splitter_vwdma_dev.st_vwdma_in_size.u16_v_size = g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tMemSize.u16_v;
    gst_splitter_vipss_dev[u8Dev][u8_rx_idx].st_splitter_vwdma_dev.u16_line_offset = g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tMemSize.u16_h;

    gst_splitter_vipss_dev[u8Dev][u8_rx_idx].st_splitter_vwdma_dev.st_vwdma_start_addr.u32_dma_start_addr_0 = g_st_app_splitter_dev[u8Dev].st_dma_addr[u8_rx_idx].u32_dma_start_addr_0;
    gst_splitter_vipss_dev[u8Dev][u8_rx_idx].st_splitter_vwdma_dev.st_vwdma_start_addr.u32_dma_start_addr_1 = g_st_app_splitter_dev[u8Dev].st_dma_addr[u8_rx_idx].u32_dma_start_addr_1;
    gst_splitter_vipss_dev[u8Dev][u8_rx_idx].st_splitter_vwdma_dev.st_vwdma_start_addr.u32_dma_start_addr_2 = g_st_app_splitter_dev[u8Dev].st_dma_addr[u8_rx_idx].u32_dma_start_addr_2;
    api_vwdma_start_addr_cfg(&gst_splitter_vipss_dev[u8Dev][u8_rx_idx].st_splitter_vwdma_dev);
    api_vwdma_line_offset_cfg(&gst_splitter_vipss_dev[u8Dev][u8_rx_idx].st_splitter_vwdma_dev);
    api_vwdma_burst_num_cfg(&gst_splitter_vipss_dev[u8Dev][u8_rx_idx].st_splitter_vwdma_dev);


     //vopss VRDMA config
    gst_splitter_vopss_dev[u8Dev][u8_rx_idx].st_splitter_vrdma_dev.b_enable = MS_TRUE;
    gst_splitter_vopss_dev[u8Dev][u8_rx_idx].st_splitter_vrdma_dev.u16_line_offset = g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tMemSize.u16_h;
    gst_splitter_vopss_dev[u8Dev][u8_rx_idx].st_splitter_vrdma_dev.st_vrdma_out_size.u16_h_size = g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tMemSize.u16_h;
    gst_splitter_vopss_dev[u8Dev][u8_rx_idx].st_splitter_vrdma_dev.st_vrdma_out_size.u16_v_size = g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tMemSize.u16_v;
    gst_splitter_vopss_dev[u8Dev][u8_rx_idx].st_splitter_vrdma_dev.st_vrdma_start_addr.u32_dma_start_addr_0 = g_st_app_splitter_dev[u8Dev].st_dma_addr[u8_rx_idx].u32_dma_start_addr_0;
    gst_splitter_vopss_dev[u8Dev][u8_rx_idx].st_splitter_vrdma_dev.st_vrdma_start_addr.u32_dma_start_addr_1 = g_st_app_splitter_dev[u8Dev].st_dma_addr[u8_rx_idx].u32_dma_start_addr_1;
    gst_splitter_vopss_dev[u8Dev][u8_rx_idx].st_splitter_vrdma_dev.st_vrdma_start_addr.u32_dma_start_addr_2 = g_st_app_splitter_dev[u8Dev].st_dma_addr[u8_rx_idx].u32_dma_start_addr_2;

    api_vrdma_enable_set(&gst_splitter_vopss_dev[u8Dev][u8_rx_idx].st_splitter_vrdma_dev);
    api_vrdma_start_addr_cfg(&gst_splitter_vopss_dev[u8Dev][u8_rx_idx].st_splitter_vrdma_dev);
    api_vrdma_burst_num_cfg(&gst_splitter_vopss_dev[u8Dev][u8_rx_idx].st_splitter_vrdma_dev);
    api_vrdma_line_offset_cfg(&gst_splitter_vopss_dev[u8Dev][u8_rx_idx].st_splitter_vrdma_dev);


    //vopss su config
    gst_splitter_vopss_dev[u8Dev][u8_rx_idx].st_splitter_su_dev.st_video_size.st_MemRect.u16_h = g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tMemSize.u16_h;
    gst_splitter_vopss_dev[u8Dev][u8_rx_idx].st_splitter_su_dev.st_video_size.st_MemRect.u16_v = g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tMemSize.u16_v;
    api_su_scaler_size_set(&gst_splitter_vopss_dev[u8Dev][u8_rx_idx].st_splitter_su_dev);

    app_video_vipss_trig(u8Dev,g_u8_ss_ch_idx[u8_rx_idx]);
    app_video_vopss_trig(u8Dev,g_u8_ss_ch_idx[u8_rx_idx]);
    mculib_delay_ms(200);
}
#endif

VOID app_splitter_rx_rotate(UINT8 u8Dev,UINT8 u8_rx_idx, UINT8 u8_rotate)
{
    UINT16 u16_h_size;
    UINT16 u16_v_size;
    //rotate input clock must be lower than 148.5M
    if(g_stVideo_HDMIRx_Timing[u8Dev][u8_rx_idx].u16_pixclk > 14900)
            return;
    ...
    g_stVideo_HDMIRx_Timing[u8Dev][u8_rx_idx].u16_hactive  > 0 ? g_stVideo_HDMIRx_Timing[u8Dev][u8_rx_idx].u16_hactive : 1920;
    gst_splitter_vipss_dev[u8Dev][VIPSS1].st_splitter_sdn_dev.st_video_size.st_InRect.u16_v =
    g_stVideo_HDMIRx_Timing[u8Dev][u8_rx_idx].u16_vactive  > 0 ? g_stVideo_HDMIRx_Timing[u8Dev][u8_rx_idx].u16_vactive : 1080;
    if(u8_rotate % 2 > 0)
    {
...
VOID app_splitter_mode_audio_src(UINT8 u8Dev)
{
    ...
    {
        b_audio_mute[u8Dev][0] = MS_FALSE;
        b_audio_mute[u8Dev][1] = MS_FALSE;
        b_audio_mute[u8Dev][2] = MS_FALSE;
        b_audio_mute[u8Dev][3] = MS_FALSE;
    }
    else
    {
...
VOID app_splitter_osd_init(UINT8 u8Dev)
{
    ...
    for(u8_idx = 0; u8_idx < 4; u8_idx ++)
    {
        ...
        g_st_misc_osd_mux[u8Dev][u8_idx].u8_tx_module = g_u8_misc_module_tx[g_u8_HDMI_TX_PROT[g_st_app_splitter_dev[u8Dev].u8_dst_sel]];
...
void app_splitter_win_cfg(UINT8 u8Dev,UINT8 u8WinID,stMs1826Wincfg_T* pstMs1826WinCfg,BOOL bIsDsc,BOOL bUpdate)
{
    ...
    //scale size
    pst_app_splitter_dev->st_scale_size[u8WinID].tInSize.u16_h = g_stVideo_HDMIRx_Timing[u8Dev][g_u8SplitterDispMapping[u8Dev][u8WinID]].u16_hactive;
    pst_app_splitter_dev->st_scale_size[u8WinID].tInSize.u16_v = g_stVideo_HDMIRx_Timing[u8Dev][g_u8SplitterDispMapping[u8Dev][u8WinID]].u16_vactive;
...
void app_splitter_user_process(UINT8 u8Dev,UINT8 u8_rx_idx)
{
    app_splitter_vipss_rx_mux_cfg(u8Dev,u8_rx_idx, &g_st_app_splitter_dev[u8Dev]);
//    g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tInSize.u16_h = g_stVideo_HDMIRx_Timing[u8Dev][u8_rx_idx].u16_hactive;
//    g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tInSize.u16_v = g_stVideo_HDMIRx_Timing[u8Dev][u8_rx_idx].u16_vactive;
    g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tInSize.u16_h = g_stVideo_HDMIRx_Timing[u8Dev][g_u8SplitterDispMapping[u8Dev][u8_rx_idx]].u16_hactive;
    g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tInSize.u16_v = g_stVideo_HDMIRx_Timing[u8Dev][g_u8SplitterDispMapping[u8Dev][u8_rx_idx]].u16_vactive;
#if 0
    g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tOutSize.u16_h =
            (((g_stMs1826WinTable[u8Dev][u8_rx_idx].u16W>g_stVideo_HDMITx_Timing[u8Dev][g_st_app_splitter_dev[u8Dev].u8_dst_sel].u16_hactive))
            ?(g_stVideo_HDMITx_Timing[u8Dev][g_st_app_splitter_dev[u8Dev].u8_dst_sel].u16_hactive):(g_stMs1826WinTable[u8Dev][u8_rx_idx].u16W));
    g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tOutSize.u16_v =
            (((g_stMs1826WinTable[u8Dev][u8_rx_idx].u16H>g_stVideo_HDMITx_Timing[u8Dev][g_st_app_splitter_dev[u8Dev].u8_dst_sel].u16_vactive))
            ?(g_stVideo_HDMITx_Timing[u8Dev][g_st_app_splitter_dev[u8Dev].u8_dst_sel].u16_vactive):(g_stMs1826WinTable[u8Dev][u8_rx_idx].u16H));
#endif
//    g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tMemSize.u16_h = return_minof_three(g_stVideo_HDMIRx_Timing[u8Dev][u8_rx_idx].u16_hactive, g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tOutSize.u16_h, MEMORY_1080P_H_SIZE_MAX);
//    g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tMemSize.u16_v = return_minof_three(g_stVideo_HDMIRx_Timing[u8Dev][u8_rx_idx].u16_vactive, g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tOutSize.u16_v, MEMORY_1080P_V_SIZE_MAX);
    g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tMemSize.u16_h = return_minof_three(g_stVideo_HDMIRx_Timing[u8Dev][g_u8SplitterDispMapping[u8Dev][u8_rx_idx]].u16_hactive, g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tOutSize.u16_h, MEMORY_1080P_H_SIZE_MAX);
    g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tMemSize.u16_v = return_minof_three(g_stVideo_HDMIRx_Timing[u8Dev][g_u8SplitterDispMapping[u8Dev][u8_rx_idx]].u16_vactive, g_st_app_splitter_dev[u8Dev].st_scale_size[u8_rx_idx].tOutSize.u16_v, MEMORY_1080P_V_SIZE_MAX);

    LOG("g_u8SplitterDispMapping[%d]      == %d\r\n",u8_rx_idx,g_u8SplitterDispMapping[u8Dev][u8_rx_idx]);
    LOG("2 st_scale_size[%d].tInSize.u16_h  == 0x%08x\r\n",u8_rx_idx,g_st_app_splitter_dev->st_scale_size[u8_rx_idx].tInSize.u16_h);
    LOG("2 st_scale_size[%d].tInSize.u16_h  == 0x%08x\r\n",u8_rx_idx,g_st_app_splitter_dev->st_scale_size[u8_rx_idx].tInSize.u16_v);
    LOG("2 st_scale_size[%d].tOutSize.u16_h == 0x%08x\r\n",u8_rx_idx,g_st_app_splitter_dev->st_scale_size[u8_rx_idx].tOutSize.u16_h);
    LOG("2 st_scale_size[%d].tOutSize.u16_v == 0x%08x\r\n",u8_rx_idx,g_st_app_splitter_dev->st_scale_size[u8_rx_idx].tOutSize.u16_v);
    LOG("2 st_scale_size[%d].tMemSize.u16_h == 0x%08x\r\n",u8_rx_idx,g_st_app_splitter_dev->st_scale_size[u8_rx_idx].tMemSize.u16_h);
    LOG("2 st_scale_size[%d].tMemSize.u16_v == 0x%08x\r\n",u8_rx_idx,g_st_app_splitter_dev->st_scale_size[u8_rx_idx].tMemSize.u16_v);

    LOG("2 st_video_win[%d].u16_hde_st == 0x%08x\r\n",u8_rx_idx,g_st_app_splitter_dev->st_video_win[u8_rx_idx].u16_hde_st);
    LOG("2 st_video_win[%d].u16_hde_sp == 0x%08x\r\n",u8_rx_idx,g_st_app_splitter_dev->st_video_win[u8_rx_idx].u16_hde_sp);
    LOG("2 st_video_win[%d].u16_vde_st == 0x%08x\r\n",u8_rx_idx,g_st_app_splitter_dev->st_video_win[u8_rx_idx].u16_vde_st);
    LOG("2 st_video_win[%d].u16_vde_sp == 0x%08x\r\n",u8_rx_idx,g_st_app_splitter_dev->st_video_win[u8_rx_idx].u16_vde_sp);

    LOG("2 st_dma_addr[%d].u32_dma_start_addr_0 == 0x%08x\r\n",u8_rx_idx,g_st_app_splitter_dev->st_dma_addr[u8_rx_idx].u32_dma_start_addr_0);
    LOG("2 st_dma_addr[%d].u32_dma_start_addr_1 == 0x%08x\r\n",u8_rx_idx,g_st_app_splitter_dev->st_dma_addr[u8_rx_idx].u32_dma_start_addr_1);
    LOG("2 st_dma_addr[%d].u32_dma_start_addr_2 == 0x%08x\r\n",u8_rx_idx,g_st_app_splitter_dev->st_dma_addr[u8_rx_idx].u32_dma_start_addr_2);
