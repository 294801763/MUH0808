...
static const uint8 Gsv2k6InitTable[] = {
    /* 01-01 Chip Power Up */
...
#else
    0x01,0x4F,0x0C, // RxA CKIO refin enable, RxB enable
    ...
    /* GSV2006 Routing Related Registers */
#if ((Gsv2k6SingleInput == 1) || (Gsv2k6In2to1to4Mode == 1))
    0x00,0x01,0xB2,
    0x00,0x02,0x00,
    0x00,0x08,0x11,
    0x01,0x05,0x10,
#elif (Gsv2k6DualSplitter == 1)
    0x00,0x01,0x89,
    0x00,0x02,0x0C,
    0x00,0x08,0x12,
    0x01,0x05,0x08,
...
static const uint8 Gsv2k6EqTable[] = {
...
static const uchar Gsv2k6VideoColorAutoVicTable[] = {
