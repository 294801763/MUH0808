...
#if Gsv2k7PhyBypass
static const uint8 Gsv2k7InitTable[] = {
    /* 01-01 Chip Power Up */
    0x00,0x00,0x80, // power up Core
    0x00,0xFE,0xFF, // Reset Rx PHY
    0x00,0xFE,0x00, // Set Rx PHY
    0x00,0xFF,0x7F, // Reset Digital
    0x00,0xFF,0x00, // Set Digital
    0x00,0x02,0xDE, // Power up TXB
    0x00,0xF7,0x0F, // Reset Tx PHY
    0x00,0xF7,0x0D, // Set TxB PHY only
    0x00,0xAD,0x09, // Disable DDC SDA
    0x00,0xAE,0x0F, // Disable DDC Disable
    0x01,0xCE,0xFF, // Manual Rx Port Fifo Control
    0x01,0xC5,0x4C, // MPLL Start Up Step 1
    0x01,0xC6,0x01, // MPLL Start Up Step 1, VC=low
    0x00,0x9A,0x80, // Audio Insertion Setting
    0x00,0x9B,0x00, // Set Audio IO Tristate and Dual In to avoid power consumption
    0x00,0x01,0x7F, // Enable both cores and point to invalid input port
    0x00,0xB6,0x0F, // pwr_channel_en_override_val_port_v
    0x00,0xB7,0x0F, // pwr_bg_en_override_val_port_v
    0x00,0xB8,0x0F, // i2c_bandgap_en_port_v
    0x00,0xB4,0x0F, // pwr_override_en_port_v
    0x01,0x4F,0xCC, // power up RxA & RxB & RxC & RxD CKIO refin
    0x01,0xA0,0x00, // No 5V Term enable control
    ...
    0x01,0x02,0x00, // [0]vsp_man_en = 0, no internal vsp
    ...
    0x05,0xC2,0x01, // RxC Ckio Low Threshold
    0x05,0xC5,0x21, // RxD Ckio Low Threshold
    0x05,0x73,0xEE, // bit[1] rxb_ckio_en_z0 = 1
    0x05,0x70,0xEE, // bit[1] rxa_ckio_en_z0 = 1
    0x05,0xC3,0xEE, // bit[1] rxd_ckio_en_z0 = 1
    0x05,0xC0,0xEE, // bit[1] rxc_ckio_en_z0 = 1
    ...
    0x05,0xC7,0x09, // rxc enlarge eq range
    0x05,0xC9,0x10, // rxc enlarge eq range
    0x05,0xCB,0x09, // rxd enlarge eq range
    0x05,0xCD,0x10, // rxd enlarge eq range
    ...
    0x3A,0x50,0x80, // manual set RXC CDR PI slewrate to 0
    0x3D,0x50,0x80, // manual set RXD CDR PI slewrate to 0
    0x01,0xC6,0x00, // MPLL Start Up Step 2
    0x01,0xC5,0xCC, // MPLL Start Up Step 2, VC=high
    /* 01-03, Tx Init */
    0x00,0x09,0xC8, // enable txcore_2_dis_osc_clk=0 only
    ...
    0x50,0x53,0x04, //; Tx Color Depth = 8 bits
    0x50,0x23,0x80, //; Manual Pixel Repetition x1
    ...
    0x00,0x03,0x05, //Rx2/TxB PHY Bypass
    0x70,0xF4,0x11, //TXB PHY revert 10 bit LSB/MSB when bypass 30 bit
    0x00,0x12,0x0C, //enable rx1/2 deskew for phy bypass
    0x00,0x99,0x02, // Disable RxID auto move and 1p4 repeater
    0x01,0xC5,0x0C, // MPLL Start Up Step 3, normal
    0x01,0xFD,0xFF, // Force CLK detection manual
    0x05,0x52,0x6F, // Low Temperature recovery setting
    0x05,0x62,0x6F, // Low Temperature recovery setting
    0x05,0x52,0x2F, // Low Temperature recovery setting
    0x05,0x62,0x2F, // Low Temperature recovery setting
    0x01,0xFD,0x00, // Release CLK detection manual
    0x01,0x16,0xFF, // HDCP noise 1p5m set
    0x00,0x93,0x00, // TxB HDCP Clock Enable
...
static const uint8 Gsv2k7InitTable[] = {
    ...
    0x00,0x9A,0x80, // Audio Insertion Setting
    0x00,0x9B,0x00, // Set Audio IO Tristate and Dual In to avoid power consumption
    0x00,0x01,0xFF, // Enable both cores and point to invalid input port
    ...
    0x00,0xB4,0x0F, // pwr_override_en_port_v
    0x01,0x4F,0xCC, // power up RxA & RxB & RxC & RxD CKIO refin
    //0x00,0x90,0x0F, // Enable Rx detection (Rx Sense)
    0x01,0xA0,0x00, // No 5V Term enable control
    0x00,0xA4,0x88, // TXA/B triming=1000
    ...
    0x30,0x24,0x84, // Change Rx2 H UnLock Threshold
    ...
    0x22,0x64,0x00, // HBR over SPDIF, Sel SPDIF Out Default
    0x32,0x4A,0x32, // set almost empty threshold
    0x32,0x54,0x3F, // audio_sample_cnt_threshold
    0x32,0x62,0x80, // Manual TDM Disable */
    0x32,0x87,0x80, // Set Output Pin Number */
    0x32,0x01,0x08, // HBR - Auto HBR Out, Output I2S Data
    0x32,0x64,0x00, // HBR over SPDIF, Sel SPDIF Out Default
    ...
    0x32,0x13,0x63, // Disable N/CTS Interrupt
    0x32,0x14,0x0C, // Disable Parity Error Interrupt
    0x32,0x15,0xC7, // Disable F N/CTS Interrupt
    0x32,0x16,0x03, // Disable AvMute/ECC Interrupt
    //0x30,0x1B,0x08, // TERC4 Error Detection Disabled, HP rescue only
    //0x32,0x46,0x40, // Disable ECC, HP rescue only
    0x32,0x50,0x04, // No CSdata Interrupt
    0x30,0x67,0xA0, // Apll Delta Manual Enable
    0x30,0x6C,0x80, // Apll Delta Code
    0x30,0x6D,0x72, // Enable Fifo Adjust
    0x30,0x9A,0x40, // Audio Lock Threshold = 64
    0x20,0x7C,0xFF, // Large CTS Stability Delta
    0x22,0x10,0x3F, // Large CTS Change Threshold
    0x30,0x7C,0xFF, // Large CTS Stability Delta
    0x32,0x10,0x3F, // Large CTS Change Threshold
    0x20,0x14,0x01, // Manual Rx1 Audio Output MCLK Factor = x2
    0x30,0x14,0x01, // Manual Rx2 Audio Output MCLK Factor = x2
    0x20,0x8F,0x01, // Manual Control Rx1 Audio Output MCLK Factor
    0x30,0x8F,0x01, // Manual Control Rx2 Audio Output MCLK Factor
    0x12,0x67,0x06, // Enable CP1 444-420 Filter
    0x12,0x6C,0x02, // CP1 444-420 configuration
    0x12,0x73,0x03, // CP1 444-420 configuration
    0x12,0x6F,0x03, // Lower margin to make CP1 output stable
    0x12,0xA2,0x06, // Enable CP2 444-420 Filter
    0x12,0xA7,0x02, // CP2 444-420 configuration
    0x12,0xAE,0x03, // CP2 444-420 configuration
    0x12,0xAA,0x03, // Lower margin to make CP2 output stable
    0x00,0x08,0x12, // Rx1 - Tx1 Audio, Rx2 - Tx2 Audio
    0x01,0x05,0x0F, // NULL - Tx1 Video, Rx2 - Tx2 Video
    0x01,0xC5,0x0C, // MPLL Start Up Step 3, normal
    0x01,0xFD,0xFF, // Force CLK detection manual
    0x05,0x52,0x6F, // Low Temperature recovery setting
    0x05,0x62,0x6F, // Low Temperature recovery setting
    ...
    0x40,0xAF,0x00, // Tx1 HBR Audio Insertion for I2S
    0x50,0xAF,0x00, // Tx2 HBR Audio Insertion for I2S
    ...
    0x62,0x2B,0x02, // TxA No Keep Out Protection
    ...
    0x72,0x2B,0x02, // TxB No Keep Out Protection
    ...
    0x01,0x16,0xFF, // HDCP noise 1p5m set
    0x00,0x93,0x02, // HDCP Clock Enable
    0x03,0x0B,0x01, // Enable Status Detection Bits
    0x26,0x70,0x20, // Rx RAM1 Edid Size is fixed to 256 bytes
    0x26,0x7E,0x20, // Rx RAM2 Edid Size is fixed to 256 bytes
    0x20,0xBE,0x0C, // Rx1 Strong ECC AVMute Enable
    0x20,0x22,0x20, // Rx1 DC Fifo no disable
    0x21,0x12,0x00, // Rx1 Disable HDCP 2.2 Auto Switch
    0x21,0x1F,0x02,
    0x30,0xBE,0x0C, // Rx2 Strong ECC AVMute Enable
    0x30,0x22,0x20, // Rx2 DC Fifo no disable
    0x31,0x12,0x00, // Rx2 Disable HDCP 2.2 Auto Switch
    0x31,0x1F,0x02,
    0xFF,0xFF,0xFF
};
#endif //Gsv2k7PhyBypass

static const uint8 Gsv2k7EqTable[] = {
...
static const uchar Gsv2k7VideoColorAutoVicTable[] = {
