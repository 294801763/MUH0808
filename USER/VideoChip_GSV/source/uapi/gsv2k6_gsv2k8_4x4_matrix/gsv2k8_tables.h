...
static const uint8 Gsv2k8InitTable[] = {
    /* 01-01 Chip Power Up */
    ...
    0x00,0x02,0x0E, // Power up TX A/B/C/D, useless for 2002
    ...
    0x32,0x64,0x00, // HBR over I2S, Sel I2S Out Default
    ...
    0x01,0x05,0x08, // Rx1 - Tx1 Video, Rx2 - Tx2 Video
    ...
    //0x04,0x1D,0x0A, // RxC VCO Max Freq = 2.8GHz
    //0x04,0x1E,0xF0, // RxC VCO Max Freq = 2.8GHz
    //0x04,0x4D,0x0A, // RxD VCO Max Freq = 2.8GHz
    //0x04,0x4E,0xF0, // RxD VCO Max Freq = 2.8GHz
    0x01,0xFD,0xFF,
    0x05,0x52,0x6F,
    0x05,0x62,0x6F,
    0x05,0x82,0x6F,
    ...
    #if Gsv2k8TxSwapPolarity
    #if Gsv2k8TxSwapChannel
    0x60,0xF4,0xF0, // TxA Ser Manual Reset but not Enabled
    #else
    0x60,0xF4,0xB0, // TxA Ser Manual Reset but not Enabled
    #endif
    #else
    #if Gsv2k8TxSwapChannel
    0x60,0xF4,0x70, // TxA Ser Manual Reset but not Enabled
    #else
    ...
    #if Gsv2k8TxSwapPolarity
    #if Gsv2k8TxSwapChannel
    0x70,0xF4,0xF0, // TxB Ser Manual Reset but not Enabled
    #else
    0x70,0xF4,0xB0, // TxB Ser Manual Reset but not Enabled
    #endif
    #else
    #if Gsv2k8TxSwapChannel
    0x70,0xF4,0x70, // TxB Ser Manual Reset but not Enabled
    #else
    ...
    0x00,0x93,0x0F, // HDCP Clock Enable
    ...
    0x21,0x1F,0x02,
    0x30,0xBE,0x04, // Rx2 Strong ECC AVMute Enable
    0x30,0x22,0x20, // Rx2 DC Fifo no disable
    0x31,0x12,0x00, // Rx2 Disable HDCP 2.2 Auto Switch
    0x31,0x1F,0x02,
    #if AvMatrix4x4Mode
    /* 4x4 special Gsv2k8 setting */
    0x00,0xAD,0x01, // Disable Rx DDC
    #endif
    0xFF,0xFF,0xFF
};

static const uint8 Gsv2k8EqTable[] = {
...
static const uchar Gsv2k8VideoColorAutoVicTable[] = {
